...
public class ASNCompundPrimitive1 {
	
	@ASNProperty(tag=23,asnClass=ASNClass.PRIVATE,constructed=false,index=0)
	...
	public ASNCompundPrimitive1() {
		
	}
	
	public ASNCompundPrimitive1(Long field1,Long field2,Boolean field3) {
