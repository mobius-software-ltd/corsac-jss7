...
public class ASNAnnotationsTest 
{
	@Rule public final ExpectFailure expectFailure = new ExpectFailure();
	 ...
	 public void InvalidSignatureTest() throws MalformedURLException {
		 ...
		 AssertionError expected = expectFailure.getFailure();
		 assertThat(expected.getMessage()).contains("error: Element 'com.mobius.software.telco.protocols.ss7.asn.primitives.InvalidSignaturePrimitive' is annotated as @ASNTag, however its method getLength annoted with @ASNLength should not have any parameters");
		 assertThat(expected.getMessage()).contains("error: Element 'com.mobius.software.telco.protocols.ss7.asn.primitives.InvalidSignaturePrimitive' is annotated as @ASNTag, however its method getLength annoted with @ASNLength should not have any parameters");	
		 assertThat(expected.getMessage()).contains("error: Element 'com.mobius.software.telco.protocols.ss7.asn.primitives.InvalidSignaturePrimitive' is annotated as @ASNTag, however its method encode annoted with @ASNEncode should have only one parameter");
	 }
