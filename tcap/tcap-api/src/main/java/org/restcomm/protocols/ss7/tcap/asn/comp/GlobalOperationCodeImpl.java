 ...
 *
 */
public class GlobalOperationCodeImpl extends ASNObjectIdentifier implements OperationCode {
    ...
    public String toString() {
        if (this.getValue() != null)
            return "OperationCode[operationType=Global, data=" + this.getValue().toString() + "]";
        else
