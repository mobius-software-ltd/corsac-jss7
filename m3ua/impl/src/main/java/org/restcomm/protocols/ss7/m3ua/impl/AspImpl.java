...
public class AspImpl implements Asp {
	...
	private void initLocalFSM() {
		...
		this.localFSM.createTransition(TransitionState.COMM_DOWN, AspState.UP_SENT.toString(),
	...
	private void initPeerFSM() {
		...
		// STATE INACTIVE /
		// ******************************************************************/
		this.peerFSM.createTransition(TransitionState.COMM_DOWN, AspState.INACTIVE.toString(),
				AspState.DOWN.toString());
