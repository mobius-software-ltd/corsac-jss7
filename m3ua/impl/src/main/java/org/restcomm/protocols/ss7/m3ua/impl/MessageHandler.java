...
public abstract class MessageHandler {
	...
	protected void sendError(RoutingContext rc, ErrorCode errorCode) {
		Error error = (Error) this.aspFactoryImpl.messageFactory.createMessage(MessageClass.MANAGEMENT,
				MessageType.ERROR);
	...
	/**
	 * Get's the ASP for any ASP Traffic Maintenance, Management, Signalling Network
	 * Management and Transfer m3ua message's received which has null Routing
	 * Context
	 *
	 * @return
	 */
