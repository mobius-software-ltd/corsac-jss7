...
public class TermAttemptAuthorizedRequestImpl extends CircuitSwitchedCallMessageImpl implements TermAttemptAuthorizedRequest {
    ...
    public TermAttemptAuthorizedRequestImpl() {
    }

    public TermAttemptAuthorizedRequestImpl(DpSpecificCommonParameters dpSpecificCommonParameters,CalledPartyBusinessGroupID calledPartyBusinessGroupID,
    ...
    public INAPMessageType getMessageType() {
        return INAPMessageType.termAttemptAuthorized_Request;
    }

    @Override
    public int getOperationCode() {
        return INAPOperationCode.termAttemptAuthorized;
    }
    ...
    public String toString() {
        ...
        sb.append("TermAttemptAuthorizedRequestIndication [");
	...
	public void validateElement() throws ASNParsingComponentException {
		if(dpSpecificCommonParameters==null)
			throw new ASNParsingComponentException("dp specific common parameters should be set for term attempt authorized request", ASNParsingComponentExceptionReason.MistypedRootParameter);
	}
}
