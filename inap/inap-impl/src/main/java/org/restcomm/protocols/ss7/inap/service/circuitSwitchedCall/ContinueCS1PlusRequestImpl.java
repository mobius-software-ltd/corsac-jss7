...
public class ContinueCS1PlusRequestImpl extends CircuitSwitchedCallMessageImpl implements ContinueCS1PlusRequest {
	private static final long serialVersionUID = 1L;

	@ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 0,constructed = true,index = -1)
	private SendingLegIDWrapperImpl legID;
	
	public ContinueCS1PlusRequestImpl() {
    }

    public ContinueCS1PlusRequestImpl(LegType legID) {
        if(legID!=null)
    ...
    public String toString() {
        ...
        sb.append("ContinueCS1PlusRequestIndication [");
