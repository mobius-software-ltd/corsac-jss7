...
public class AnalysedInformationRequestImpl extends CircuitSwitchedCallMessageImpl implements AnalysedInformationRequest {
	...
	public void validateElement() throws ASNParsingComponentException {
		if(dpSpecificCommonParameters==null)
			throw new ASNParsingComponentException("dp specific common parameters should be set for analyzed information request", ASNParsingComponentExceptionReason.MistypedRootParameter);
	}
}
