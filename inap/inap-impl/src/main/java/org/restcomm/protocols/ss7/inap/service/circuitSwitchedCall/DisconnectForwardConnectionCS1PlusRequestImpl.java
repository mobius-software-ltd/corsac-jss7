...
public class DisconnectForwardConnectionCS1PlusRequestImpl extends CircuitSwitchedCallMessageImpl implements DisconnectForwardConnectionCS1PlusRequest {
	private static final long serialVersionUID = 1L;

	@ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 0,constructed = true,index = -1)
	private SendingLegIDWrapperImpl legID;
	
	public DisconnectForwardConnectionCS1PlusRequestImpl() {
    }

    public DisconnectForwardConnectionCS1PlusRequestImpl(LegType legID) {
        if(legID!=null)
    ...
    public INAPMessageType getMessageType() {
        return INAPMessageType.disconnectForwardConnectionWithArgument_Request;
    }

    @Override
    public int getOperationCode() {
        return INAPOperationCode.disconnectForwardConnection;
    }
    ...
    public String toString() {
        ...
        sb.append("DisconnectForwardConnectionCS1PlusRequestIndication [");
	...
	public void validateElement() throws ASNParsingComponentException {
		if(legID==null)
			throw new ASNParsingComponentException("leg ID should be set for disconnect forward connection request", ASNParsingComponentExceptionReason.MistypedRootParameter);
	}
}
