...
public class CollectedInformationRequestImpl extends CircuitSwitchedCallMessageImpl implements CollectedInformationRequest {
    ...
    public CollectedInformationRequestImpl() {
    }

    public CollectedInformationRequestImpl(DpSpecificCommonParameters dpSpecificCommonParameters,CalledPartyNumberIsup dialedDigits,
    ...
    public INAPMessageType getMessageType() {
        return INAPMessageType.collectedInformation_Request;
    }

    @Override
    public int getOperationCode() {
        return INAPOperationCode.collectedInformation;
    }
    ...
    public String toString() {
        ...
        sb.append("CollectedInformationRequestIndication [");
	...
	public void validateElement() throws ASNParsingComponentException {
		if(dpSpecificCommonParameters==null)
			throw new ASNParsingComponentException("dp specific common parameters should be set for collected information request", ASNParsingComponentExceptionReason.MistypedRootParameter);
	}
}
