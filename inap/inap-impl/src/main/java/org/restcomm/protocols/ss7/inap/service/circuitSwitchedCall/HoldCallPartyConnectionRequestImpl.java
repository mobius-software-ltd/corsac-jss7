...
public class HoldCallPartyConnectionRequestImpl extends CircuitSwitchedCallMessageImpl implements HoldCallPartyConnectionRequest {
	...
	public void validateElement() throws ASNParsingComponentException {
		if(legID==null)
			throw new ASNParsingComponentException("leg ID should be set for hold call party connection request", ASNParsingComponentExceptionReason.MistypedRootParameter);
	}
}
