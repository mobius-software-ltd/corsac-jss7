...
public class INAPServiceCircuitSwitchedCallImpl extends INAPServiceBaseImpl implements INAPServiceCircuitSwitchedCall {
    ...
    @Override
    public INAPDialogCircuitSwitchedCall createNewDialog(INAPApplicationContext appCntx, SccpAddress origAddress, SccpAddress destAddress) throws INAPException {
        return this.createNewDialog(appCntx, origAddress, destAddress, null);
    }

    @Override
    public INAPDialogCircuitSwitchedCall createNewDialog(INAPApplicationContext appCntx, SccpAddress origAddress, SccpAddress destAddress, Long localTrId)
    ...
    public long[] getLinkedOperationList(long operCode) {
        if (operCode == INAPOperationCode.playAnnouncement || operCode == INAPOperationCode.promptAndCollectUserInformation) {
    ...
    public void processComponent(ComponentType compType, OperationCode oc, INAPMessage parameter, INAPDialog capDialog,
        ...
        switch (ocValueInt) {
        	case INAPOperationCode.initialDP:
        		 if (acn == INAPApplicationContext.Q1218_generic_SSF_to_SCF_AC || acn == INAPApplicationContext.Core_INAP_CS1_SSP_to_SCP_AC
        	...
        	case INAPOperationCode.originationAttemptAuthorized:
        		 if (acn == INAPApplicationContext.Q1218_DP_specific_SSF_to_SCF_AC || acn == INAPApplicationContext.Q1218_DP_specific_SCF_to_SSF_AC) {
					 if(parameter instanceof OriginationAttemptAuthorizedRequest) {
		    	        ...
		    	        for (INAPServiceListener serLis : this.serviceListeners) {
		    	            try {
		    	                serLis.onINAPMessage(ind);
		    	                ((INAPServiceCircuitSwitchedCallListener) serLis).onOriginationAttemptAuthorizedRequest(ind);
		    	            } catch (Exception e) {
        	...
        	case INAPOperationCode.tMidCall:
       		...
       		//case INAPOperationCode.retrieve:
       			if (acn == INAPApplicationContext.Q1218_assist_handoff_SSF_to_SCF_AC || acn == INAPApplicationContext.Q1218_SRF_to_SCF_AC ||
       					acn == INAPApplicationContext.Core_INAP_CS1_assist_handoff_SSP_to_SCP_AC || acn == INAPApplicationContext.Core_INAP_CS1_IP_to_SCP_AC ||
       					acn == INAPApplicationContext.Ericcson_cs1plus_SSP_TO_SCP_AC || acn == INAPApplicationContext.Ericcson_cs1plus_assist_handoff_SSP_to_SCP_AC || 
       		...
       		case INAPOperationCode.establishTemporaryConnection:
       			if (acn == INAPApplicationContext.Q1218_generic_SSF_to_SCF_AC || acn == INAPApplicationContext.Q1218_DP_specific_SSF_to_SCF_AC ||
       					acn == INAPApplicationContext.Q1218_generic_SCF_to_SSF_AC || acn == INAPApplicationContext.Q1218_DP_specific_SCF_to_SSF_AC ||
       					acn == INAPApplicationContext.Core_INAP_CS1_SSP_to_SCP_AC || acn == INAPApplicationContext.Core_INAP_CS1_SCP_to_SSP_AC ||
       					acn == INAPApplicationContext.Ericcson_cs1plus_SSP_TO_SCP_AC || acn == INAPApplicationContext.Ericcson_cs1plus_SCP_to_SSP_AC) {
					if(parameter instanceof EstablishTemporaryConnectionRequest) {
		    	        ...
		    	        for (INAPServiceListener serLis : this.serviceListeners) {
		    	            try {
		    	                serLis.onINAPMessage(ind);
		    	                ((INAPServiceCircuitSwitchedCallListener) serLis).onEstablishTemporaryConnectionRequest(ind);
		    	            } catch (Exception e) {
       		...
       		case INAPOperationCode.disconnectForwardConnection:
       			if (acn == INAPApplicationContext.Q1218_generic_SSF_to_SCF_AC || acn == INAPApplicationContext.Q1218_DP_specific_SSF_to_SCF_AC ||
					acn == INAPApplicationContext.Q1218_assist_handoff_SSF_to_SCF_AC || acn == INAPApplicationContext.Q1218_generic_SCF_to_SSF_AC ||
					acn == INAPApplicationContext.Q1218_DP_specific_SCF_to_SSF_AC || acn == INAPApplicationContext.Core_INAP_CS1_SSP_to_SCP_AC ||
					acn == INAPApplicationContext.Core_INAP_CS1_assist_handoff_SSP_to_SCP_AC || acn == INAPApplicationContext.Core_INAP_CS1_SCP_to_SSP_AC) {
					if(parameter==null) {
						processed = true;
       			...
       			else if(acn == INAPApplicationContext.Ericcson_cs1plus_SSP_TO_SCP_AC || acn == INAPApplicationContext.Ericcson_cs1plus_assist_handoff_SSP_to_SCP_AC ||
        	...
        	case INAPOperationCode.requestReportBCSMEvent:
       		...
       		case INAPOperationCode.eventReportBCSM:
       			if (acn == INAPApplicationContext.Q1218_generic_SSF_to_SCF_AC || acn == INAPApplicationContext.Q1218_generic_SCF_to_SSF_AC ||
					acn == INAPApplicationContext.Core_INAP_CS1_SSP_to_SCP_AC || acn == INAPApplicationContext.Core_INAP_CS1_SCP_to_SSP_AC ||
					acn == INAPApplicationContext.Ericcson_cs1plus_SSP_TO_SCP_AC || acn == INAPApplicationContext.Ericcson_cs1plus_SCP_to_SSP_AC) {
       			...
       			if (acn == INAPApplicationContext.Q1218_generic_SSF_to_SCF_AC || acn == INAPApplicationContext.Q1218_DP_specific_SSF_to_SCF_AC ||
					...
					if(parameter instanceof RequestNotificationChargingEventRequest) {
		    	        ...
		    	        for (INAPServiceListener serLis : this.serviceListeners) {
		    	            try {
		    	                serLis.onINAPMessage(ind);
		    	                ((INAPServiceCircuitSwitchedCallListener) serLis).onRequestNotificationChargingEventRequest(ind);
		    	            } catch (Exception e) {
		    	                loger.error("Error processing requestNotificationChargingEventRequest: " + e.getMessage(), e);
		    	            }
		    	        }
			        }
		        }
       		...
       		case INAPOperationCode.continueCode:
       			...
       			else if (acn == INAPApplicationContext.Ericcson_cs1plus_SSP_TO_SCP_AC || acn == INAPApplicationContext.Ericcson_cs1plus_SCP_to_SSP_AC) {
    				if(parameter==null) {
    					processed = true;
    					ContinueRequest ind = new ContinueRequestImpl();		 	        	
    		   	        for (INAPServiceListener serLis : this.serviceListeners) {
       		...
       		case INAPOperationCode.initiateCallAttempt:
       			if (acn == INAPApplicationContext.Q1218_generic_SCF_to_SSF_AC || acn == INAPApplicationContext.Q1218_DP_specific_SCF_to_SSF_AC ||
					acn == INAPApplicationContext.Core_INAP_CS1_SCP_to_SSP_AC || acn == INAPApplicationContext.Ericcson_cs1plus_SSP_TO_SCP_AC || 
					acn == INAPApplicationContext.Ericcson_cs1plus_SCP_to_SSP_AC) {
       		...
       		case INAPOperationCode.resetTimer:
       			if (acn == INAPApplicationContext.Q1218_generic_SSF_to_SCF_AC || acn == INAPApplicationContext.Q1218_DP_specific_SSF_to_SCF_AC ||
					...
					acn == INAPApplicationContext.Core_INAP_CS1_assist_handoff_SSP_to_SCP_AC || acn == INAPApplicationContext.Core_INAP_CS1_IP_to_SCP_AC ||
					acn == INAPApplicationContext.Core_INAP_CS1_SCP_to_SSP_AC || acn == INAPApplicationContext.Ericcson_cs1plus_SSP_TO_SCP_AC ||
					acn == INAPApplicationContext.Ericcson_cs1plus_assist_handoff_SSP_to_SCP_AC || acn == INAPApplicationContext.Ericcson_cs1plus_IP_to_SCP_AC ||
					acn == INAPApplicationContext.Ericcson_cs1plus_SCP_to_SSP_AC) {
        	...
        	case INAPOperationCode.requestCurrentStatusReport:
        		if (acn == INAPApplicationContext.Q1218_generic_SSF_to_SCF_AC || acn == INAPApplicationContext.Q1218_DP_specific_SSF_to_SCF_AC ||
					acn == INAPApplicationContext.Q1218_assist_handoff_SSF_to_SCF_AC || acn == INAPApplicationContext.Q1218_generic_SCF_to_SSF_AC ||
					acn == INAPApplicationContext.Q1218_DP_specific_SCF_to_SSF_AC || acn == INAPApplicationContext.Q1218_SCF_to_SSF_status_reporting_AC) {
        			if(compType == ComponentType.Invoke) {
						if(parameter instanceof RequestCurrentStatusReportRequest) {
			    	        ...
			    	        for (INAPServiceListener serLis : this.serviceListeners) {
			    	            try {
			    	                serLis.onINAPMessage(ind);
			    	                ((INAPServiceCircuitSwitchedCallListener) serLis).onRequestCurrentStatusReportRequest(ind);
			    	            } catch (Exception e) {
        				...
        				if(parameter instanceof RequestCurrentStatusReportResponse) {
			    	        ...
			    	        for (INAPServiceListener serLis : this.serviceListeners) {
			    	            try {
			    	                serLis.onINAPMessage(ind);
			    	                ((INAPServiceCircuitSwitchedCallListener) serLis).onRequestCurrentStatusReportResponse(ind);
			    	            } catch (Exception e) {
			    	                loger.error("Error processing requestCurrentStatusReportResponse: " + e.getMessage(), e);
			    	            }
			    	        }
				        }
        			}
        	...
        	case INAPOperationCode.requestEveryStatusChangeReport:
        		if (acn == INAPApplicationContext.Q1218_generic_SSF_to_SCF_AC || acn == INAPApplicationContext.Q1218_DP_specific_SSF_to_SCF_AC ||
        			...
        			if(parameter instanceof RequestEveryStatusChangeReportRequest) {
		    	        ...
		    	        for (INAPServiceListener serLis : this.serviceListeners) {
		    	            try {
		    	                serLis.onINAPMessage(ind);
		    	                ((INAPServiceCircuitSwitchedCallListener) serLis).onRequestEveryStatusChangeReportRequest(ind);
		    	            } catch (Exception e) {
       			...
       			if (acn == INAPApplicationContext.Q1218_generic_SSF_to_SCF_AC || acn == INAPApplicationContext.Q1218_DP_specific_SSF_to_SCF_AC ||
	    			...
	    			if(parameter instanceof RequestFirstStatusMatchReportRequest) {
		    	        ...
		    	        for (INAPServiceListener serLis : this.serviceListeners) {
		    	            try {
		    	                serLis.onINAPMessage(ind);
		    	                ((INAPServiceCircuitSwitchedCallListener) serLis).onRequestFirstStatusMatchReportRequest(ind);
		    	            } catch (Exception e) {
       		...
       		case INAPOperationCode.callGap:
       			if (acn == INAPApplicationContext.Q1218_generic_SSF_to_SCF_AC || acn == INAPApplicationContext.Q1218_DP_specific_SSF_to_SCF_AC ||
					acn == INAPApplicationContext.Q1218_SCF_to_SSF_traffic_management_AC || acn == INAPApplicationContext.Core_INAP_CS1_SSP_to_SCP_AC ||
					acn == INAPApplicationContext.Core_INAP_CS1_SCP_to_SSP_traffic_management_AC || acn == INAPApplicationContext.Ericcson_cs1plus_SSP_TO_SCP_AC ||
					acn == INAPApplicationContext.Ericcson_cs1plus_SCP_to_SSP_AC || acn == INAPApplicationContext.Ericcson_cs1plus_SCP_to_SSP_traffic_management_AC) {
       		...
       		case INAPOperationCode.activateServiceFiltering:
       			if (acn == INAPApplicationContext.Q1218_SCF_to_SSF_service_management_AC || acn == INAPApplicationContext.Q1218_SSF_to_SCF_service_management_AC ||
					acn == INAPApplicationContext.Core_INAP_CS1_SCP_to_SSP_service_management_AC || acn == INAPApplicationContext.Core_INAP_CS1_SSP_to_SCP_service_management_AC ||
					acn == INAPApplicationContext.Ericcson_cs1plus_SSP_TO_SCP_AC || acn == INAPApplicationContext.Ericcson_cs1plus_SCP_to_SSP_service_management_AC ||
        	...
        	case INAPOperationCode.playAnnouncement:        		
        		if (acn == INAPApplicationContext.Q1218_generic_SSF_to_SCF_AC || acn == INAPApplicationContext.Q1218_DP_specific_SSF_to_SCF_AC ||
    				acn == INAPApplicationContext.Q1218_assist_handoff_SSF_to_SCF_AC || acn == INAPApplicationContext.Q1218_SRF_to_SCF_AC ||
    				acn == INAPApplicationContext.Q1218_generic_SCF_to_SSF_AC || acn == INAPApplicationContext.Q1218_DP_specific_SCF_to_SSF_AC ||
    				acn == INAPApplicationContext.Core_INAP_CS1_SSP_to_SCP_AC || acn == INAPApplicationContext.Core_INAP_CS1_assist_handoff_SSP_to_SCP_AC ||
    				acn == INAPApplicationContext.Core_INAP_CS1_IP_to_SCP_AC || acn == INAPApplicationContext.Core_INAP_CS1_SCP_to_SSP_AC ||
    				acn == INAPApplicationContext.Ericcson_cs1plus_SSP_TO_SCP_AC || acn == INAPApplicationContext.Ericcson_cs1plus_assist_handoff_SSP_to_SCP_AC || 
    				acn == INAPApplicationContext.Ericcson_cs1plus_IP_to_SCP_AC || acn == INAPApplicationContext.Ericcson_cs1plus_SCP_to_SSP_AC ) {
        	...
        	case INAPOperationCode.promptAndCollectUserInformation:
        			...
        			if(compType == ComponentType.Invoke) {
						if(parameter instanceof PromptAndCollectUserInformationRequest) {
				            ...
				            for (INAPServiceListener serLis : this.serviceListeners) {
				   	            try {
				   	                serLis.onINAPMessage(ind);
				   	                ((INAPServiceCircuitSwitchedCallListener) serLis).onPromptAndCollectUserInformationRequest(ind);
				   	            } catch (Exception e) {
						...
						if(parameter instanceof PromptAndCollectUserInformationResponse) {
				            ...
				            for (INAPServiceListener serLis : this.serviceListeners) {
				   	            try {
				   	                serLis.onINAPMessage(ind);
				   	                ((INAPServiceCircuitSwitchedCallListener) serLis).onPromptAndCollectUserInformationResponse(ind);
				   	            } catch (Exception e) {
       		...
       		case INAPOperationCode.cancelCode:
       			if (acn == INAPApplicationContext.Q1218_generic_SSF_to_SCF_AC || acn == INAPApplicationContext.Q1218_DP_specific_SSF_to_SCF_AC ||
					acn == INAPApplicationContext.Q1218_assist_handoff_SSF_to_SCF_AC || acn == INAPApplicationContext.Q1218_SRF_to_SCF_AC ||
					acn == INAPApplicationContext.Q1218_generic_SCF_to_SSF_AC || acn == INAPApplicationContext.Q1218_DP_specific_SCF_to_SSF_AC ||
					acn == INAPApplicationContext.Q1218_SCF_to_SSF_status_reporting_AC || acn == INAPApplicationContext.Core_INAP_CS1_SSP_to_SCP_AC || 
					acn == INAPApplicationContext.Core_INAP_CS1_assist_handoff_SSP_to_SCP_AC || acn == INAPApplicationContext.Core_INAP_CS1_IP_to_SCP_AC || 
					acn == INAPApplicationContext.Core_INAP_CS1_SCP_to_SSP_AC || acn == INAPApplicationContext.Ericcson_cs1plus_SSP_TO_SCP_AC || 
					acn == INAPApplicationContext.Ericcson_cs1plus_assist_handoff_SSP_to_SCP_AC ||  acn == INAPApplicationContext.Ericcson_cs1plus_IP_to_SCP_AC || 
					acn == INAPApplicationContext.Ericcson_cs1plus_SCP_to_SSP_AC ) {
       		...
       		case INAPOperationCode.callLimit:
       			if (acn == INAPApplicationContext.Ericcson_cs1plus_SSP_TO_SCP_AC || acn == INAPApplicationContext.Ericcson_cs1plus_SCP_to_SSP_traffic_limitation_AC) {
       		...
       		case INAPOperationCode.continueWithArgument:
       			if (acn == INAPApplicationContext.Ericcson_cs1plus_SSP_TO_SCP_AC || acn == INAPApplicationContext.Ericcson_cs1plus_SCP_to_SSP_AC) {
        	...
        	case INAPOperationCode.dialogueUserInformation:
        		if (acn == INAPApplicationContext.Ericcson_cs1plus_SSP_TO_SCP_AC || acn == INAPApplicationContext.Ericcson_cs1plus_assist_handoff_SSP_to_SCP_AC ||
        			acn == INAPApplicationContext.Ericcson_cs1plus_IP_to_SCP_AC || acn == INAPApplicationContext.Ericcson_cs1plus_SCP_to_SSP_AC ||
        			acn == INAPApplicationContext.Ericcson_cs1plus_SCP_to_SSP_traffic_management_AC || acn == INAPApplicationContext.Ericcson_cs1plus_SCP_to_SSP_service_management_AC ||
        			acn == INAPApplicationContext.Ericcson_cs1plus_SSP_to_SCP_service_management_AC || acn == INAPApplicationContext.Ericcson_cs1plus_data_management_AC ||
        ...
        if(!processed) {
        	if(parameter == null)
        		 throw new INAPParsingComponentException("Error while decoding , Parameter is mandatory but not found",INAPParsingComponentExceptionReason.MistypedParameter);
