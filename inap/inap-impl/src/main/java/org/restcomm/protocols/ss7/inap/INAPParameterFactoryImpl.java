...
import org.restcomm.protocols.ss7.inap.service.circuitSwitchedCall.primitive.InitialDPArgExtensionImpl;
...
public class INAPParameterFactoryImpl implements INAPParameterFactory {
    ...
    @Override
    public OriginalCalledNumberIsup createOriginalCalledNumber(OriginalCalledNumber originalCalledNumber) throws INAPException {
    	try {
