...
public class OAnswerRequestImpl extends CircuitSwitchedCallMessageImpl implements OAnswerRequest {
	...
	@ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 2,constructed = false,index = -1,defaultImplementation = CallingPartySubaddressImpl.class)
	...
	@ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 8,constructed = true,index = -1, defaultImplementation = RouteListImpl.class)
    ...
    public OAnswerRequestImpl() {
    }

    public OAnswerRequestImpl(DpSpecificCommonParameters dpSpecificCommonParameters,CallingPartyBusinessGroupID callingPartyBusinessGroupID,
    ...
    public INAPMessageType getMessageType() {
        return INAPMessageType.oAnswer_Request;
    }

    @Override
    public int getOperationCode() {
        return INAPOperationCode.oAnswer;
    }
