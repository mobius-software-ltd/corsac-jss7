...
public class OCalledPartyBusyRequestImpl extends CircuitSwitchedCallMessageImpl implements OCalledPartyBusyRequest {
	...
	@ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 13,constructed = false,index = -1, defaultImplementation = CarrierImpl.class)
	private Carrier carrier;

    public OCalledPartyBusyRequestImpl() {
    }

    public OCalledPartyBusyRequestImpl(DpSpecificCommonParameters dpSpecificCommonParameters,CauseIsup busyCause,
    ...
    public INAPMessageType getMessageType() {
        return INAPMessageType.oCalledPartyBusy_Request;
    }

    @Override
    public int getOperationCode() {
        return INAPOperationCode.oCalledPartyBusy;
    }
	...
	public void validateElement() throws ASNParsingComponentException {
		if(dpSpecificCommonParameters==null)
			throw new ASNParsingComponentException("dp specific common parameters should be set for ocalled party busy request", ASNParsingComponentExceptionReason.MistypedRootParameter);
	}
}
