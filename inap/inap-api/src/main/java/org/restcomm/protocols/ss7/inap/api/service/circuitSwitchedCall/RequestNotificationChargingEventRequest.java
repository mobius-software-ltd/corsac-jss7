...
-- Direction: SCF -> SSF, Timer: Trnc -- This operation is used by the SCF to instruct the SSF on how to manage the charging events
 ...
 *
 */
public interface RequestNotificationChargingEventRequest extends CircuitSwitchedCallMessage {

    List<ChargingEvent> getChargingEventList();
}
