...
SCIBillingChargingCharacteristics ::= CHOICE {
	chargingInformation [00] SEQUENCE {
		orderStartOfCharging [00] NULL OPTIONAL,
		...
		createDefaultBillingRecord [03] NULL OPTIONAL
		‐‐ ...
	},
...
public interface SCIBillingChargingCharacteristicsCS1 extends SCIBillingChargingCharacteristics {

	ChargingInformation getChargingInformation();

	ChargingAnalysisInputData getChargingAnalysisInputData();
}