...
AChBillingChargingCharacteristics ::= SEQUENCE {
	reportCondition [00] CHOICE {
		reportAtEndOfConnection [01] NULL, ‐‐ partyToCharge must be indicated
		reportAtChargeLimit [02] INTEGER (0..32767),
		reportImmediately [03] NULL
	},
	requestedReportInfo [01] SEQUENCE {
		accumulatedCharge [00] NULL OPTIONAL,
		actualTariff [01] NULL OPTIONAL,
		chargeableDuration [03] NULL OPTIONAL,
		timeOfAnswer [04] NULL OPTIONAL
		‐‐ ...	
	}
	‐‐ ...
}
...
public interface AchBillingChargingCharacteristicsCS1 extends AChBillingChargingCharacteristics {

	ReportCondition getReportCondition();

	RequestedReportInfo getRequestedReportInfo();
}