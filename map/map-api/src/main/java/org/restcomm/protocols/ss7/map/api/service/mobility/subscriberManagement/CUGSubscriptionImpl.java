...
public class CUGSubscriptionImpl {
	...
	private CUGInterlockImpl cugInterlock = null;
     ...
     *
     */
    public CUGSubscriptionImpl(int cugIndex, CUGInterlockImpl cugInterlock, IntraCUGOptions intraCugOptions,
    ...
    public String toString() {
        ...
        if (this.basicService != null && this.basicService.getExtBasicServiceCodeImpl()!=null) {
            ...
            for (ExtBasicServiceCodeImpl be : this.basicService.getExtBasicServiceCodeImpl()) {
                if (firstItem)
                    firstItem = false;
                else
                    sb.append(", ");
