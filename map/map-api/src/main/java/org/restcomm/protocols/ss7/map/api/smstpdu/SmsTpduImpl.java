...
public abstract class SmsTpduImpl {
    ...
    public static SmsTpduImpl createInstance(ByteBuf data, boolean mobileOriginatedMessage, Charset gsm8Charset)
            throws MAPException {
        ...
        int tpMti = data.readByte() & _MASK_TP_MTI;
    ...
    public abstract void encodeData(ByteBuf buf) throws MAPException;
}
