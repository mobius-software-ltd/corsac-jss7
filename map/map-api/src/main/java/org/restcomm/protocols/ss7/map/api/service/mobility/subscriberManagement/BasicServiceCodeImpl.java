...
public class BasicServiceCodeImpl {
    ...
    private BearerServiceCodeImpl bearerService;
    ...
    public BasicServiceCodeImpl(TeleserviceCodeImpl teleservice) {
        this.teleservice = teleservice;
    }

    public BasicServiceCodeImpl(BearerServiceCodeImpl bearerService) {
        this.bearerService = bearerService;
    }

    public BearerServiceCodeImpl getBearerService() {
