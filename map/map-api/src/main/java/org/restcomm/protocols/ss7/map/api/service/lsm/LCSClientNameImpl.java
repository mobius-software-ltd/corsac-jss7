...
public class LCSClientNameImpl {
    ...
    private USSDStringImpl nameString;
     ...
     */
    public LCSClientNameImpl(CBSDataCodingScheme dataCodingScheme, USSDStringImpl nameString, LCSFormatIndicator lcsFormatIndicator) {
        super();
     ...
     */
    public USSDStringImpl getNameString() {
