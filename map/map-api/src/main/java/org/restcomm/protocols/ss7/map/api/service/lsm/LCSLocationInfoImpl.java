...
public class LCSLocationInfoImpl {
    ...
    private SupportedLCSCapabilitySetsImpl supportedLCSCapabilitySets;
    
    @ASNProperty(asnClass=ASNClass.CONTEXT_SPECIFIC,tag=5,constructed=false,index=-1)
    private SupportedLCSCapabilitySetsImpl additionalLCSCapabilitySets;
    
    @ASNProperty(asnClass=ASNClass.CONTEXT_SPECIFIC,tag=6,constructed=false,index=-1)
    private DiameterIdentityImpl mmeName;
    
    @ASNProperty(asnClass=ASNClass.CONTEXT_SPECIFIC,tag=8,constructed=false,index=-1)
    private DiameterIdentityImpl aaaServerName;
     ...
     */
    public LCSLocationInfoImpl(ISDNAddressStringImpl networkNodeNumber, LMSIImpl lmsi, MAPExtensionContainerImpl extensionContainer,
     ...
     */
    public SupportedLCSCapabilitySetsImpl getSupportedLCSCapabilitySets() {
     ...
     */
    public SupportedLCSCapabilitySetsImpl getAdditionalLCSCapabilitySets() {
    ...
    public DiameterIdentityImpl getAaaServerName() {
