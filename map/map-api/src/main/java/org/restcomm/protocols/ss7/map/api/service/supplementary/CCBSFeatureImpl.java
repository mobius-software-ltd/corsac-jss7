...
import org.restcomm.protocols.ss7.map.api.service.mobility.subscriberManagement.BasicServiceCodeWrapperImpl;
...
public class CCBSFeatureImpl {
    ...
    private ISDNAddressStringImpl bSubscriberNumber;
    ...
    public CCBSFeatureImpl(Integer ccbsIndex, ISDNAddressStringImpl bSubscriberNumber, ISDNAddressStringImpl bSubscriberSubaddress, BasicServiceCodeImpl basicServiceCode) {
        if(ccbsIndex!=null) {
    ...
    public ISDNAddressStringImpl getBSubscriberNumber() {
        return bSubscriberNumber;
    }

    public ISDNAddressStringImpl getBSubscriberSubaddress() {
        return bSubscriberSubaddress;
    }

    public BasicServiceCodeImpl getBasicServiceCode() {
    	if(basicServiceCode==null)
    		return null;
