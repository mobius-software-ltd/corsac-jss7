...
public class CUGFeatureImpl {
    ...
    private InterCUGRestrictionsImpl interCugRestrictions = null;
     ...
     *
     */
    public CUGFeatureImpl(ExtBasicServiceCodeImpl basicService, Integer preferentialCugIndicator,
    ...
    public InterCUGRestrictionsImpl getInterCugRestrictions() {
    ...
    public String toString() {
        ...
        if (this.interCugRestrictions != null) {
            ...
            sb.append(this.interCugRestrictions.getValue());
            sb.append(", ");
        }
