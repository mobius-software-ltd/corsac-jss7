...
public class ValidityPeriodImpl {
    ...
    private AbsoluteTimeStampImpl absoluteFormatValue;
    private ValidityEnhancedFormatDataImpl enhancedFormatValue;

    public ValidityPeriodImpl(int relativeFormatValue) {
        this.relativeFormatValue = relativeFormatValue;
    }

    public ValidityPeriodImpl(AbsoluteTimeStampImpl absoluteFormatValue) {
        this.absoluteFormatValue = absoluteFormatValue;
    }

    public ValidityPeriodImpl(ValidityEnhancedFormatDataImpl enhancedFormatValue) {
    ...
    public AbsoluteTimeStampImpl getAbsoluteFormatValue() {
        return this.absoluteFormatValue;
    }

    public ValidityEnhancedFormatDataImpl getEnhancedFormatValue() {
