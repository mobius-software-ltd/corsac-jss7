...
public abstract class TbcdString {
    ...
    public TbcdString(int minLength, int maxLength, String _PrimitiveName, String data,Boolean hasFiller) {
    ...
    public static void encodeString(ByteBuf buffer, String data) throws MAPException {
