 ...
 *
 */
public class SmsDeliverReportTpduImpl extends SmsTpduImpl {
    ...
    public SmsDeliverReportTpduImpl(FailureCauseImpl failureCause, ProtocolIdentifierImpl protocolIdentifier, UserDataImpl userData) {
        this();
