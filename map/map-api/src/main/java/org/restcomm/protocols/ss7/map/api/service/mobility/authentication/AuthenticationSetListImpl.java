...
public class AuthenticationSetListImpl {
    ...
    private TripletListImpl tripletList;
    
	private TripletListImpl tripletList2;
    
    @ASNProperty(asnClass=ASNClass.CONTEXT_SPECIFIC,tag=1,constructed=true,index=-1)
    private QuintupletListImpl quintupletList;
    
    public AuthenticationSetListImpl() {
    }

    public AuthenticationSetListImpl(TripletListImpl tripletList,long mapVersion) {
    	if(mapVersion>=3)
    ...
    public AuthenticationSetListImpl(QuintupletListImpl quintupletList) {
        this.quintupletList = quintupletList;
    }

    public TripletListImpl getTripletList() {
    	if(tripletList==null)
    		return tripletList2;
    ...
    public QuintupletListImpl getQuintupletList() {
