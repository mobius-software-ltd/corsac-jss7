...
public class RequestedSubscriptionInfoImpl {
    ...
    public RequestedSubscriptionInfoImpl(SSForBSCodeImpl ssForBSCode, boolean isOdb, RequestedCAMELSubscriptionInfo requestedCAMELSubscriptionInfo,
                                         boolean isSupportedVlrCamelPhases, boolean isSupportedSgsnCamelPhases, MAPExtensionContainerImpl extensionContainer,
    ...
    public SSForBSCodeImpl getRequestedSSInfo() {
