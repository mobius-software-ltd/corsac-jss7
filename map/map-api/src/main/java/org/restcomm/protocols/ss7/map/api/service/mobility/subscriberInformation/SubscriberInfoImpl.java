...
public class SubscriberInfoImpl {
    ...
    private LocationInformationImpl locationInformation = null;
    ...
    private LocationInformationGPRSImpl locationInformationGPRS = null;
    ...
    private MSClassmark2Impl msClassmark2 = null;
    
    @ASNProperty(asnClass=ASNClass.CONTEXT_SPECIFIC,tag=3,constructed=true,index=-1)
    private GPRSMSClassImpl gprsMSClass = null;
    
    @ASNProperty(asnClass=ASNClass.CONTEXT_SPECIFIC,tag=8,constructed=true,index=-1)
    private MNPInfoResImpl mnpInfoRes = null;

    public SubscriberInfoImpl() {
    }

    public SubscriberInfoImpl(LocationInformationImpl locationInformation, SubscriberStateImpl subscriberState,
            MAPExtensionContainerImpl extensionContainer, LocationInformationGPRSImpl locationInformationGPRS, PSSubscriberStateImpl psSubscriberState,
            IMEIImpl imei, MSClassmark2Impl msClassmark2, GPRSMSClassImpl gprsMSClass, MNPInfoResImpl mnpInfoRes) {
     ...
     */
    public PSSubscriberStateImpl getPSSubscriberState() {
     ...
     */
    public MNPInfoResImpl getMNPInfoRes() {
