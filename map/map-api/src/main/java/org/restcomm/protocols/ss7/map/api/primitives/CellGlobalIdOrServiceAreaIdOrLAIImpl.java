...
public class CellGlobalIdOrServiceAreaIdOrLAIImpl 
{
	...
	private CellGlobalIdOrServiceAreaIdFixedLengthImpl cellGlobalIdOrServiceAreaIdFixedLength = null;
    
	@ASNProperty(asnClass=ASNClass.CONTEXT_SPECIFIC,tag=1,constructed=false,index=-1)
	private LAIFixedLengthImpl laiFixedLength = null;
    ...
    public CellGlobalIdOrServiceAreaIdOrLAIImpl(CellGlobalIdOrServiceAreaIdFixedLengthImpl cellGlobalIdOrServiceAreaIdFixedLength) {
        this.cellGlobalIdOrServiceAreaIdFixedLength = cellGlobalIdOrServiceAreaIdFixedLength;
    }

    public CellGlobalIdOrServiceAreaIdOrLAIImpl(LAIFixedLengthImpl laiFixedLength) {
     ...
     */
    public CellGlobalIdOrServiceAreaIdFixedLengthImpl getCellGlobalIdOrServiceAreaIdFixedLength() {
     ...
     */
    public LAIFixedLengthImpl getLAIFixedLength() {
