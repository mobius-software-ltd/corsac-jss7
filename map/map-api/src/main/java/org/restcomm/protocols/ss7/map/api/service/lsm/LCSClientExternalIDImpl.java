...
public class LCSClientExternalIDImpl {
	@ASNProperty(asnClass=ASNClass.CONTEXT_SPECIFIC,tag=0,constructed=false,index=-1)
    private ISDNAddressStringImpl externalAddress;
     ...
     *
     */
    public LCSClientExternalIDImpl(final ISDNAddressStringImpl externalAddress, final MAPExtensionContainerImpl extensionContainer) {
     ...
     */
    public ISDNAddressStringImpl getExternalAddress() {
