...
public class DestinationNumberLengthListWrapperImpl {
	private ArrayList<ASNInteger> destinationNumberLengthList;

    public DestinationNumberLengthListWrapperImpl() {
    }

    public DestinationNumberLengthListWrapperImpl(ArrayList<ASNInteger> destinationNumberLengthList) {
        this.destinationNumberLengthList = destinationNumberLengthList;
    }

    public ArrayList<ASNInteger> getDestinationNumberLengthList() {
