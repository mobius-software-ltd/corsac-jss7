...
public class SSCSIImpl {
    ...
    private SSCamelDataImpl ssCamelData;
    ...
    public SSCSIImpl(SSCamelDataImpl ssCamelData, MAPExtensionContainerImpl extensionContainer, boolean notificationToCSE,
            boolean csiActive) {
    ...
    public SSCamelDataImpl getSsCamelData() {
