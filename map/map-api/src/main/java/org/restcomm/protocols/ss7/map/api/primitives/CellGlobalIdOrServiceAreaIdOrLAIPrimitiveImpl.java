...
public class CellGlobalIdOrServiceAreaIdOrLAIPrimitiveImpl {
	...
	public Integer getLength(ASNParser parser) {
		...
		if(cellGlobalIdOrServiceAreaIdOrLAI.getCellGlobalIdOrServiceAreaIdFixedLength()!=null)
			return cellGlobalIdOrServiceAreaIdOrLAI.getCellGlobalIdOrServiceAreaIdFixedLength().getLength(parser);
		else if(cellGlobalIdOrServiceAreaIdOrLAI.getLAIFixedLength()!=null)
			return cellGlobalIdOrServiceAreaIdOrLAI.getLAIFixedLength().getLength(parser);
	...
	public void encode(ASNParser parser,ByteBuf buffer) {
		...
		if(cellGlobalIdOrServiceAreaIdOrLAI.getCellGlobalIdOrServiceAreaIdFixedLength()!=null)
			cellGlobalIdOrServiceAreaIdOrLAI.getCellGlobalIdOrServiceAreaIdFixedLength().encode(parser,buffer);
		else if(cellGlobalIdOrServiceAreaIdOrLAI.getLAIFixedLength()!=null)
			cellGlobalIdOrServiceAreaIdOrLAI.getLAIFixedLength().encode(parser,buffer);		
	}
