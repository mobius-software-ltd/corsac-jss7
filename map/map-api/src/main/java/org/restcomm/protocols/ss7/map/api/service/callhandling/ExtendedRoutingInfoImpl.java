...
public class ExtendedRoutingInfoImpl {
	...
	private CamelRoutingInfoImpl camelRoutingInfo = null;

    public ExtendedRoutingInfoImpl() {
    }

    public ExtendedRoutingInfoImpl(RoutingInfoImpl routingInfo) {
        this.routingInfo = routingInfo;
    }

    public ExtendedRoutingInfoImpl(CamelRoutingInfoImpl camelRoutingInfo) {
        this.camelRoutingInfo = camelRoutingInfo;
    }

    public RoutingInfoImpl getRoutingInfo() {
        return this.routingInfo;
    }

    public CamelRoutingInfoImpl getCamelRoutingInfo() {
