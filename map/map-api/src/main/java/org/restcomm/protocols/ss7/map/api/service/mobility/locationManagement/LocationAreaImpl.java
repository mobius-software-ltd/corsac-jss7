...
public class LocationAreaImpl {
    ...
    private LAIFixedLengthImpl laiFixedLength;
    ...
    public LocationAreaImpl(LAIFixedLengthImpl laiFixedLength) {
        this.laiFixedLength = laiFixedLength;
    }

    public LocationAreaImpl(LACImpl lac) {
        this.lac = lac;
    }
