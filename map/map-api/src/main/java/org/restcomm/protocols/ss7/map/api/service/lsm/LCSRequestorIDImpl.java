...
public class LCSRequestorIDImpl {
    ...
    private USSDStringImpl requestorIDString;
     ...
     */
    public LCSRequestorIDImpl(CBSDataCodingScheme dataCodingScheme, USSDStringImpl requestorIDString,
     ...
     */
    public USSDStringImpl getRequestorIDString() {
