...
public class GPRSMSClassImpl {
    ...
    private MSNetworkCapabilityImpl mSNetworkCapability;
    
    @ASNProperty(asnClass=ASNClass.CONTEXT_SPECIFIC,tag=1,constructed=false,index=-1)
    private MSRadioAccessCapabilityImpl mSRadioAccessCapability;
    ...
    public GPRSMSClassImpl(MSNetworkCapabilityImpl mSNetworkCapability, MSRadioAccessCapabilityImpl mSRadioAccessCapability) {
     ...
     */
    public MSNetworkCapabilityImpl getMSNetworkCapability() {
     ...
     */
    public MSRadioAccessCapabilityImpl getMSRadioAccessCapability() {
