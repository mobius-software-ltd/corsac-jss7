...
public class MOLRClassImpl {
	@ASNProperty(asnClass=ASNClass.UNIVERSAL,tag=4,constructed=true,index=-1)
    ...
    public MOLRClassImpl(SSCodeImpl ssCode, ExtSSStatusImpl ssStatus, MAPExtensionContainerImpl extensionContainer) {
        this.ssCode = ssCode;
