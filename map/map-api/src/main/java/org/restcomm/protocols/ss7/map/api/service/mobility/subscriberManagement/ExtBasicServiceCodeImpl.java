...
public class ExtBasicServiceCodeImpl {
    ...
    private ExtBearerServiceCodeImpl extBearerService;
    
    @ASNProperty(asnClass=ASNClass.CONTEXT_SPECIFIC,tag=3,constructed=false,index=-1)
    private ExtTeleserviceCodeImpl extTeleservice;

    public ExtBasicServiceCodeImpl() {
    }

    public ExtBasicServiceCodeImpl(ExtBearerServiceCodeImpl extBearerService) {
        this.extBearerService = extBearerService;
    }

    public ExtBasicServiceCodeImpl(ExtTeleserviceCodeImpl extTeleservice) {
        this.extTeleservice = extTeleservice;
    }

    public ExtBearerServiceCodeImpl getExtBearerService() {
        return extBearerService;
    }

    public ExtTeleserviceCodeImpl getExtTeleservice() {
