...
public class LCSCodewordImpl {
    ...
    private USSDStringImpl lcsCodewordString;
     ...
     */
    public LCSCodewordImpl(CBSDataCodingScheme dataCodingScheme, USSDStringImpl lcsCodewordString) {
        super();
     ...
     */
    public USSDStringImpl getLCSCodewordString() {
