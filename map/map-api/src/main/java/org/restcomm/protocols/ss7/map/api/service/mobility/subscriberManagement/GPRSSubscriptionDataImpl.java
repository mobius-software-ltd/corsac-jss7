...
import org.restcomm.protocols.ss7.map.api.service.mobility.subscriberInformation.PDPContextListWrapperImpl;
...
public class GPRSSubscriptionDataImpl {
    ...
    private APNOIReplacementImpl apnOiReplacement = null;
    ...
    public String toString() {
        ...
        if (this.gprsDataList != null && this.gprsDataList.getPDPContextList()!=null) {
            ...
            for (PDPContextImpl be : this.gprsDataList.getPDPContextList()) {
                if (firstItem)
                    firstItem = false;
                else
                    sb.append(", ");
