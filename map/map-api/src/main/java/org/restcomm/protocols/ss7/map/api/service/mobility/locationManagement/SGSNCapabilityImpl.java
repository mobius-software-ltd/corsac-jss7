...
public class SGSNCapabilityImpl {
    ...
    private SupportedRATTypesImpl supportedRATTypesIndicator;
    
    @ASNProperty(asnClass=ASNClass.CONTEXT_SPECIFIC,tag=9,constructed=false,index=-1)
    private SupportedFeaturesImpl supportedFeatures;
    ...
    public SGSNCapabilityImpl(boolean solsaSupportIndicator, MAPExtensionContainerImpl extensionContainer,
    ...
    public SuperChargerInfoImpl getSuperChargerSupportedInServingNetworkEntity() {
    	if(superChargerSupportedInServingNetworkEntity==null)
    		return null;
    ...
    public SupportedRATTypesImpl getSupportedRATTypesIndicator() {
