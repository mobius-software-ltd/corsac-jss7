...
public class AreaEventInfoImpl {
    ...
    private AreaDefinitionImpl areaDefinition;
     ...
     * @param intervalTime
     */
    public AreaEventInfoImpl(AreaDefinitionImpl areaDefinition, OccurrenceInfo occurrenceInfo, Integer intervalTime) {
     ...
     */
    public AreaDefinitionImpl getAreaDefinition() {
