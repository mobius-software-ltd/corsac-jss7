...
public class LSADataImpl {
    ...
    private LSAIdentityImpl lsaIdentity;
    
    @ASNProperty(asnClass=ASNClass.CONTEXT_SPECIFIC,tag=1,constructed=false,index=1)
    private LSAAttributesImpl lsaAttributes;
    ...
    public LSADataImpl(LSAIdentityImpl lsaIdentity, LSAAttributesImpl lsaAttributes, boolean lsaActiveModeIndicator,
    ...
    public LSAAttributesImpl getLSAAttributes() {
