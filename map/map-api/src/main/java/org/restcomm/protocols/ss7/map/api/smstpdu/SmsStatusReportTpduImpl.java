 ...
 *
 */
public class SmsStatusReportTpduImpl extends SmsTpduImpl {
    ...
    private AddressFieldImpl recipientAddress;
    private AbsoluteTimeStampImpl serviceCentreTimeStamp;
    private AbsoluteTimeStampImpl dischargeTime;
    ...
    public AddressFieldImpl getRecipientAddress() {
    ...
    public AbsoluteTimeStampImpl getDischargeTime() {
