...
public class AreaImpl {
    ...
    private AreaIdentificationImpl areaIdentification;
     ...
     */
    public AreaImpl(AreaType areaType, AreaIdentificationImpl areaIdentification) {
        if(areaType!=null) {
     ...
     */
    public AreaIdentificationImpl getAreaIdentification() {
