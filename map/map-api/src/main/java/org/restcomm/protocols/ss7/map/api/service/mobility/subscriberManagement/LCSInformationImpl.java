...
public class LCSInformationImpl {
    ...
    public String toString() {
        ...
        if (this.gmlcList != null && this.gmlcList.getISDNAddressString()!=null) {
            ...
            for (ISDNAddressStringImpl be : this.gmlcList.getISDNAddressString()) {
                if (firstItem)
                    firstItem = false;
                else
                    sb.append(", ");
        ...
        if (this.lcsPrivacyExceptionList != null && this.lcsPrivacyExceptionList.getLCSPrivacyClass()!=null) {
            ...
            boolean firstItem = true;
            for (LCSPrivacyClassImpl be : this.lcsPrivacyExceptionList.getLCSPrivacyClass()) {
                if (firstItem)
                    firstItem = false;
                else
                    sb.append(", ");
        ...
        if (this.molrList != null && this.molrList.getMOLRClass()!=null) {
            sb.append("molrList=[");
            boolean firstItem = true;
            for (MOLRClassImpl be : this.molrList.getMOLRClass()) {
                if (firstItem)
                    firstItem = false;
                else
                    sb.append(", ");
        ...
        if (this.addLcsPrivacyExceptionList != null && this.addLcsPrivacyExceptionList.getLCSPrivacyClass()!=null) {
            ...
            boolean firstItem = true;
            for (LCSPrivacyClassImpl be : this.addLcsPrivacyExceptionList.getLCSPrivacyClass()) {
                if (firstItem)
                    firstItem = false;
                else
                    sb.append(", ");
