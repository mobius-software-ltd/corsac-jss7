...
public class Client extends EventTestHarness {
	...
	public MAPDialogMobility clientDialogMobility;
	public MAPDialogLsm clientDialogLsm;
	...
	public Client(MAPStack mapStack, SccpAddress thisAddress, SccpAddress remoteAddress) {
		super(logger);
	...
	public void sendEmptyV1Request() throws Exception {
		...
		// this.observerdEvents.add(TestEvent.createSentEvent(EventType.AlertServiceCentreIndication,
		// null, sequence++));
		clientDialogSms.send(dummyCallback);
	...
	public void sendForwardShortMessageRequestV1() throws Exception {
		...
		super.handleSent(EventType.ForwardShortMessageIndication, null);
		clientDialogSms.send(dummyCallback);
	}
	...
	public void sendForwardShortMessageRequestV2() throws Exception {
		...
		// AddressStringImpl orgiReference =
		...
		// this.thisAddress, orgiReference,
	...
	public void sendMtForwardShortMessageRequest() throws Exception {
		...
		super.handleSent(EventType.MtForwardShortMessageIndication, null);
		clientDialogSms.send(dummyCallback);
	}
	...
	public void sendReportSMDeliveryStatus3() throws Exception {
		...
		clientDialogSms.addReportSMDeliveryStatusRequest(msisdn1, serviceCentreAddress, sMDeliveryOutcome,
				sbsentSubscriberDiagnosticSM, MAPExtensionContainerTest.GetTestExtensionContainer(),
				gprsSupportIndicator, deliveryOutcomeIndicator, additionalSMDeliveryOutcome,
	...
	public void sendSendRoutingInfoForSM() throws Exception {
		...
		clientDialogSms.addSendRoutingInfoForSMRequest(msisdn1, false, servCenAddr1,
				...
				new SM_RP_SMEAImpl(AddressFieldImpl
						.createMessage(Unpooled.wrappedBuffer(new byte[] { 11, -111, 39, 34, -125, 72, 35, -15 }))),
				SMDeliveryNotIntended.onlyIMSIRequested, true, null, false, false, null, null);

		super.handleSent(EventType.SendRoutingInfoForSMIndication, null);
		clientDialogSms.send(dummyCallback);
	}
	...
	public void sendSendAuthenticationInfo_V3() throws Exception {
		...
		clientDialogMobility.addSendAuthenticationInfoRequest(imsi, 3, true, true, null, null, RequestingNodeType.sgsn,
				null, 5, false);

		super.handleSent(EventType.SendAuthenticationInfo_V3, null);
	...
	public void sendSendAuthenticationInfo_V2() throws Exception {
		...
		super.handleSent(EventType.SendAuthenticationInfo_V2, null);
		clientDialogMobility.send(dummyCallback);
	}
	...
	public void sendUpdateLocation() throws Exception {
		...
		clientDialogMobility.addUpdateLocationRequest(imsi, mscNumber, null, vlrNumber, lmsi, null, null, true, false,
				null, addInfo, null, false, true);

		super.handleSent(EventType.UpdateLocation, null);
		clientDialogMobility.send(dummyCallback);
	}
	...
	public void sendCancelLocation() throws Exception {
		...
		super.handleSent(EventType.CancelLocation, null);
		clientDialogMobility.send(dummyCallback);
	}
	...
	public void sendSendIdentification_V2() throws Exception {
		...
		super.handleSent(EventType.SendIdentification, null);
		clientDialogMobility.send(dummyCallback);
	}
	...
	public void sendUpdateGprsLocation_V3() throws Exception {
		...
		MAPExtensionContainer extensionContainer = MAPExtensionContainerTest.GetTestExtensionContainer();
		SGSNCapability sgsnCapability = new SGSNCapabilityImpl(true, extensionContainer, null, false, null, null, null,
				false, null, null, false, null);
		boolean informPreviousNetworkEntity = true;
		boolean psLCSNotSupportedByUE = true;
		GSNAddress vGmlcAddress = new GSNAddressImpl(GSNAddressAddressType.IPv4,
				Unpooled.wrappedBuffer(new byte[] { 38, 48, 81, 5 }));
		...
		clientDialogMobility.addUpdateGprsLocationRequest(imsi, sgsnNumber, sgsnAddress, extensionContainer,
				sgsnCapability, informPreviousNetworkEntity, psLCSNotSupportedByUE, vGmlcAddress, addInfo, epsInfo,
				servingNodeTypeIndicator, skipSubscriberDataUpdate, usedRATType, gprsSubscriptionDataNotNeeded,
				nodeTypeIndicator, areaRestricted, ueReachableIndicator, epsSubscriptionDataNotNeeded,
				uesrvccCapability);

		super.handleSent(EventType.UpdateGprsLocation, null);
		clientDialogMobility.send(dummyCallback);
	}
	...
	public void sendPurgeMS_V3() throws Exception {
		...
		super.handleSent(EventType.PurgeMS, null);
		clientDialogMobility.send(dummyCallback);
	}
	...
	public void sendReset_V2() throws Exception {
		...
		appCnt = MAPApplicationContext.getInstance(MAPApplicationContextName.resetContext,
				MAPApplicationContextVersion.version2);
	...
	public void sendRestoreData() throws Exception {
		...
		super.handleSent(EventType.RestoreData, null);
		clientDialogMobility.send(dummyCallback);
	}
	...
	public void sendProvideRoamingNumber() throws Exception {
		...
		// MAPExtensionContainerTest.GetTestExtensionContainer();
		// AlertingPattern alertingPattern = new
		// AlertingPatternImpl(AlertingCategory.Category5);
		boolean ccbsCall = false;
		// SupportedCamelPhases supportedCamelPhasesInInterrogatingNode = new
		// SupportedCamelPhasesImpl(true, true, false, false);
		// MAPExtensionContainer extensionContainerforAddSigInfo =
		// this.mapParameterFactory.createMAPExtensionContainer(al,
		// new byte[] { 31, 32, 33 });
		// ExtExternalSignalInfo additionalSignalInfo = new
		// ExtExternalSignalInfoImpl(signalInfo,
		...
		// OfferedCamel4CSIs offeredCamel4CSIsInInterrogatingNode = new
		// OfferedCamel4CSIsImpl(false, false, false, false,
		// true, true, true);
		...
		// ISDNAddressStringImpl oldMSCNumber = new
		// ISDNAddressStringImpl(AddressNature.international_number, NumberingPlan.ISDN,
		// "22225");

		clientDialogCallHandling.addProvideRoamingNumberRequest(imsi, mscNumber, msisdn, lmsi, gsmBearerCapability,
				networkSignalInfo, suppressionOfAnnouncement, gmscAddress, null, orInterrogation, null, null, ccbsCall,
				null, null, orNotSupportedInGMSC, prePagingSupported, longFTNSupported, suppressVtCsi, null,
				mtRoamingRetrySupported, null, null, mtrfIndicator, null);

		super.handleSent(EventType.ProvideRoamingNumber, null);
	...
	public void sendIstCommand() throws Exception {
		...
		MAPApplicationContext appCnt = MAPApplicationContext.getInstance(
				MAPApplicationContextName.ServiceTerminationContext, MAPApplicationContextVersion.version3);
		...
		super.handleSent(EventType.IstCommand, null);
		clientDialogCallHandling.send(dummyCallback);
	}
	...
	public void sendAnyTimeInterrogation() throws Exception {
		...
		super.handleSent(EventType.AnyTimeInterrogation, null);
		clientDialogMobility.send(dummyCallback);
	}
	...
	public void sendAnyTimeSubscriptionInterrogation() throws Exception {
		...
		MAPApplicationContext applicationContext = MAPApplicationContext.getInstance(
				MAPApplicationContextName.anyTimeInfoHandlingContext, MAPApplicationContextVersion.version3);

		clientDialogMobility = this.mapProvider.getMAPServiceMobility().createNewDialog(applicationContext,
				this.thisAddress, null, this.remoteAddress, null, 0);
		...
		RequestedSubscriptionInfo requestedSubscriptionInfo = new RequestedSubscriptionInfoImpl(null, false,
				...
				AdditionalRequestedCAMELSubscriptionInfo.mtSmsCSI, false, true, false, false, false, false, false);
		...
		super.handleSent(EventType.AnyTimeSubscriptionInterrogation, null);
		clientDialogMobility.send(dummyCallback);
	}
	...
	public void sendProvideSubscriberInfo() throws Exception {
		...
		appCnt = MAPApplicationContext.getInstance(MAPApplicationContextName.subscriberInfoEnquiryContext,
				MAPApplicationContextVersion.version3);
		...
		// IMSI imsi, LMSI lmsi, RequestedInfo requestedInfo, MAPExtensionContainer
		// extensionContainer, EMLPPPriority callPriority

		super.handleSent(EventType.ProvideSubscriberInfo, null);
		clientDialogMobility.send(dummyCallback);
	}
	...
	public void sendProvideSubscriberLocation() throws Exception {
		...
		super.handleSent(EventType.ProvideSubscriberLocation, null);
	...
	public void sendSubscriberLocationReport() throws Exception {
		...
		clientDialogLsm.addSubscriberLocationReportRequest(LCSEvent.emergencyCallOrigination, lcsClientID,
				lcsLocationInfo, null, null, null, null, null, null, null, null, null, null, null, null, null, null,
				null, null, false, false, null, null, null, null, false, null, null, null);

		super.handleSent(EventType.SubscriberLocationReport, null);
		clientDialogLsm.send(dummyCallback);
	}
	...
	public void sendSendRoutingInforForLCS() throws Exception {
		...
		super.handleSent(EventType.SendRoutingInfoForLCS, null);
		clientDialogLsm.send(dummyCallback);
	}
	...
	public void sendCheckImei() throws Exception {
		...
		RequestedEquipmentInfo requestedEquipmentInfo = this.mapParameterFactory.createRequestedEquipmentInfo(true,
				false);
		MAPExtensionContainer extensionContainer = MAPExtensionContainerTest.GetTestExtensionContainer();
	...
	public void send_sendRoutingInfoForSMRequest_reportSMDeliveryStatusRequest() throws Exception {
		...
		clientDialogSms.addReportSMDeliveryStatusRequest(msisdn, serviceCentreAddress,
...
//        MAPExtensionContainer extensionContainer = MAPExtensionContainerTest.GetTestExtensionContainer();
		...
		clientDialogMobility.addInsertSubscriberDataRequest(imsi, msisdn, category, subscriberStatus, bearerServiceList,
				...
				extensionContainer, naeaPreferredCI, gprsSubscriptionData,
				...
				epsSubscriptionData, csgSubscriptionDataList, ueReachabilityRequestIndicator, sgsnNumber, mmeName,
				subscribedPeriodicRAUTAUtimer, vplmnLIPAAllowed, mdtUserConsent, subscribedPeriodicLAUtimer);

		super.handleSent(EventType.InsertSubscriberData, null);
		clientDialogMobility.send(dummyCallback);
	}
	...
	public void sendDeleteSubscriberData_V3() throws Exception {
		...
		extBearerServiceCode = this.mapParameterFactory
				.createExtBearerServiceCode(BearerServiceCodeValue.padAccessCA_9600bps);
		...
		clientDialogMobility.addDeleteSubscriberDataRequest(imsi, basicServiceList, ssList, false, null, false, false,
				false, null, null, false, null, false, false, null, false, false, null, false, false);

		super.handleSent(EventType.DeleteSubscriberData, null);
		clientDialogMobility.send(dummyCallback);
	}
	...
	public void sendDeleteSubscriberData_V2() throws Exception {
		...
		clientDialogMobility.addDeleteSubscriberDataRequest(imsi, null, null, true, egionalSubscriptionIdentifier,
				false, false, false, null, null, false, null, false, false, null, false, false, null, false, false);
	...
	public void sendSendRoutingInformation_V3() throws Exception {
		...
		clientDialogCallHandling.addSendRoutingInformationRequest(msisdn, cugCheckInfo, numberOfForwarding,
				...
				suppressIncomingCallBarring, gsmSCFInitiatedCall, basicServiceGroup2, networkSignalInfo2, suppressMTSS,
				mtRoamingRetrySupported, callPriority);

		super.handleSent(EventType.SendRoutingInformation, null);
		clientDialogCallHandling.send(dummyCallback);
	}
	...
	public void sendSendImsi() throws Exception {
		...
		super.handleSent(EventType.SendImsi, null);
	...
	public void sendRegisterSS() throws Exception {
		this.mapProvider.getMAPServiceSupplementary().acivate();
		MAPApplicationContext appCnt = null;
		appCnt = MAPApplicationContext.getInstance(MAPApplicationContextName.networkFunctionalSsContext,
				MAPApplicationContextVersion.version2);
	...
	public void sendEraseSS() throws Exception {
		...
		super.handleSent(EventType.EraseSS, null);
		clientDialog.send(dummyCallback);
	}
	...
	public void sendActivateSS() throws Exception {
		...
		super.handleSent(EventType.ActivateSS, null);
		clientDialog.send(dummyCallback);
	}
	...
	public void sendDeactivateSS() throws Exception {
		...
		super.handleSent(EventType.DeactivateSS, null);
		clientDialog.send(dummyCallback);
	}
	...
	public void sendInterrogateSS() throws Exception {
		...
		super.handleSent(EventType.InterrogateSS, null);
		clientDialog.send(dummyCallback);
	}
	...
	public void sendReadyForSM() throws Exception {
		this.mapProvider.getMAPServiceSms().acivate();
		MAPApplicationContext appCnt = null;
		appCnt = MAPApplicationContext.getInstance(MAPApplicationContextName.mwdMngtContext,
				MAPApplicationContextVersion.version3);
		...
		super.handleSent(EventType.ReadyForSM, null);
		clientDialogSms.send(dummyCallback);
	}
	...
	public void sendNoteSubscriberPresent() throws Exception {
		...
		super.handleSent(EventType.NoteSubscriberPresent, null);
		clientDialogSms.send(dummyCallback);
	...
	public void sendSendRoutingInfoForGprsRequest() throws Exception {
		...
		appCnt = MAPApplicationContext.getInstance(MAPApplicationContextName.gprsLocationInfoRetrievalContext,
				MAPApplicationContextVersion.version4);

		clientDialogPdpContextActivation = this.mapProvider.getMAPServicePdpContextActivation().createNewDialog(appCnt,
				this.thisAddress, null, this.remoteAddress, null, 0);
		...
		super.handleSent(EventType.SendRoutingInfoForGprs, null);
	...
	public void sendActivateTraceModeRequest_Oam() throws Exception {
		...
		appCnt = MAPApplicationContext.getInstance(MAPApplicationContextName.tracingContext,
				MAPApplicationContextVersion.version3);
		...
		TraceReference traceReference = this.mapParameterFactory
				.createTraceReference(Unpooled.wrappedBuffer(traceReferenceData));
		TraceType traceType = this.mapParameterFactory.createTraceType(21);
		clientDialogOam.addActivateTraceModeRequest(imsi, traceReference, traceType, null, null, null, null, null, null,
				null, null, null);
...
//        TraceInterfaceList traceInterfaceList, TraceEventList traceEventList, GSNAddress traceCollectionEntity, MDTConfiguration mdtConfiguration
		...
		super.handleSent(EventType.ActivateTraceMode, null);
		clientDialogOam.send(dummyCallback);
	}
	...
	public void sendActivateTraceModeRequest_Mobility() throws Exception {
		...
		TraceReference traceReference = this.mapParameterFactory
				.createTraceReference(Unpooled.wrappedBuffer(traceReferenceData));
		TraceType traceType = this.mapParameterFactory.createTraceType(21);
		clientDialogMobility.addActivateTraceModeRequest(imsi, traceReference, traceType, null, null, null, null, null,
				null, null, null, null);
//        IMSI imsi, TraceReference traceReference, TraceType traceType, AddressString omcId,
//        MAPExtensionContainer extensionContainer, TraceReference2 traceReference2, TraceDepthList traceDepthList, TraceNETypeList traceNeTypeList,
//        TraceInterfaceList traceInterfaceList, TraceEventList traceEventList, GSNAddress traceCollectionEntity, MDTConfiguration mdtConfiguration
	...
	public void sendAuthenticationFailureReport() throws Exception {
		...
		appCnt = MAPApplicationContext.getInstance(MAPApplicationContextName.authenticationFailureReportContext,
				MAPApplicationContextVersion.version3);
		...
		IMSI imsi = this.mapParameterFactory.createIMSI("88888777773333");
		clientDialogMobility.addAuthenticationFailureReportRequest(imsi, FailureCause.wrongNetworkSignature, null, null,
				null, null, null, null);

		super.handleSent(EventType.AuthenticationFailureReport, null);
		clientDialogMobility.send(dummyCallback);
	}
	...
	public void sendRegisterPassword() throws Exception {
		...
		super.handleSent(EventType.RegisterPassword, null);
		clientDialog.send(dummyCallback);
	}
	...
	public void sendMystypedParameter() throws MAPException {
		...
		ASNOctetString octetString = new ASNOctetString(Unpooled.wrappedBuffer(new byte[] { 1, 1, 1, 1, 1 }), null,
				null, null, false);
		try {
			((MAPDialogImpl) clientDialog).getTcapDialog().sendData(10, null, null, null,
	...
	public void actionB() throws MAPException {
		...
		clientDialog = this.mapProvider.getMAPServiceSupplementary().createNewDialog(appCnt, this.thisAddress,
				orgiReference, badAddr, destReference, 0);
