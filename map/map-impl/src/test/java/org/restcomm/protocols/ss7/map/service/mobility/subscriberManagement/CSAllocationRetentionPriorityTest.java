...
public class CSAllocationRetentionPriorityTest {
    ...
    public void testDecode() throws Exception {
    	...
    	parser.replaceClass(CSAllocationRetentionPriorityImpl.class);
    	
        byte[] data = this.getData();
        ASNDecodeResult result=parser.decode(Unpooled.wrappedBuffer(data));
        assertFalse(result.getHadErrors());
        assertTrue(result.getResult() instanceof CSAllocationRetentionPriorityImpl);
        CSAllocationRetentionPriorityImpl prim = (CSAllocationRetentionPriorityImpl)result.getResult();        
