...
public class MapParserLoopTest {
	...
	try {
	    ...
	    SccpStackImpl sccpStack = new SccpStackImpl(".sccp", workerPool.getPeriodicQueue());
	    sccpStack.start();
	    TCAPStackImpl tcapStack = new TCAPStackImpl(".tcap", sccpStack.getSccpProvider(), 6,
	...
	M3UAManagementImpl m3uaStack = new M3UAManagementImpl(".m3ua", null, uuidGenerator, workerPool.getQueue(),
		workerPool.getPeriodicQueue());
