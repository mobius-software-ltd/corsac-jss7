...
public class CallDiversionTreatmentIndicatorTest {
    ...
    public void testDecode() throws Exception {
    	...
    	parser.replaceClass(CallDiversionTreatmentIndicatorImpl.class);
    	
    	byte[] data = this.getData();
    	ASNDecodeResult result=parser.decode(Unpooled.wrappedBuffer(data));
        assertFalse(result.getHadErrors());
        assertTrue(result.getResult() instanceof CallDiversionTreatmentIndicatorImpl);
        CallDiversionTreatmentIndicatorImpl prim = (CallDiversionTreatmentIndicatorImpl)result.getResult();
