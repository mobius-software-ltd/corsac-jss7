...
public class MSCSInterfaceListTest {
    ...
    public void testDecode() throws Exception {
    	...
    	parser.replaceClass(MSCSInterfaceListImpl.class);
    	
        byte[] rawData = getEncodedData();
        ASNDecodeResult result=parser.decode(Unpooled.wrappedBuffer(rawData));
        assertFalse(result.getHadErrors());
        assertTrue(result.getResult() instanceof MSCSInterfaceListImpl);
        MSCSInterfaceListImpl asc = (MSCSInterfaceListImpl)result.getResult();
