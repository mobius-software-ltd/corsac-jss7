...
public class MGWInterfaceListTest {
    ...
    public void testDecode() throws Exception {
    	...
    	parser.replaceClass(MGWInterfaceListImpl.class);
    	
    	byte[] rawData = getEncodedData();
        ASNDecodeResult result=parser.decode(Unpooled.wrappedBuffer(rawData));
        assertFalse(result.getHadErrors());
        assertTrue(result.getResult() instanceof MGWInterfaceListImpl);
        MGWInterfaceListImpl asc = (MGWInterfaceListImpl)result.getResult();
