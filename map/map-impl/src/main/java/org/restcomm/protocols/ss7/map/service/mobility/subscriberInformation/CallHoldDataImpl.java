...
public class CallHoldDataImpl implements CallHoldData {
	...
	public void validateElement() throws ASNParsingComponentException {
		if(ssStatus==null)
			throw new ASNParsingComponentException("ss status should be set for call hold data", ASNParsingComponentExceptionReason.MistypedParameter);
	}
}
