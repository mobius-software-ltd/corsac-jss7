...
*
*/
public class MGWEventListImpl extends ASNBitString implements MGWEventList {
    ...
    public MGWEventListImpl(boolean context) {
    	if (context)
            this.setBit(_ID_context);
    }

    public boolean getContext() {
        return this.isBitSet(_ID_context);
    }

    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("MGWEventList [");
