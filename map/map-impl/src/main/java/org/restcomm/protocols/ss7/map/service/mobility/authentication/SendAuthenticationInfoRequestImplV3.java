...
public class SendAuthenticationInfoRequestImplV3 extends MobilityMessageImpl implements SendAuthenticationInfoRequest {
	...
	public void validateElement() throws ASNParsingComponentException {
		...
		if(numberOfRequestedVectors==null)
			throw new ASNParsingComponentException("number of requested vectors should be set for send authentication info request", ASNParsingComponentExceptionReason.MistypedRootParameter);
	}
}
