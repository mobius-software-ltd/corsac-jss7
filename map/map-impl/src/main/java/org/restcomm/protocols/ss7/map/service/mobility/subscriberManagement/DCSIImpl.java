...
public class DCSIImpl implements DCSI {
    ...
    public DCSIImpl(List<DPAnalysedInfoCriterium> dpAnalysedInfoCriteriaList, Integer camelCapabilityHandling,
    ...
    public List<DPAnalysedInfoCriterium> getDPAnalysedInfoCriteriaList() {
    ...
    public String toString() {
        ...
        if (this.dpAnalysedInfoCriteriaList != null && this.dpAnalysedInfoCriteriaList.getDPAnalysedInfoCriteriumList()!=null) {
            ...
            for (DPAnalysedInfoCriterium be : this.dpAnalysedInfoCriteriaList.getDPAnalysedInfoCriteriumList()) {
                if (firstItem)
                    firstItem = false;
                else
                    sb.append(", ");
