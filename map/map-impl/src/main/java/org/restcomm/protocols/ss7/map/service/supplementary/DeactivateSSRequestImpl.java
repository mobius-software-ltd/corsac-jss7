...
public class DeactivateSSRequestImpl extends SupplementaryMessageImpl implements DeactivateSSRequest {
	...
	public void validateElement() throws ASNParsingComponentException {
		if(ssForBSCode==null)
			throw new ASNParsingComponentException("SS for BS Code should be set for deactivate SS request", ASNParsingComponentExceptionReason.MistypedRootParameter);
	}
}