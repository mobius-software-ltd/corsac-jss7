...
public class APNConfigurationListWrapperImpl {
	...
	@ASNProperty(asnClass=ASNClass.UNIVERSAL,tag=16,constructed=true,index=-1,defaultImplementation = APNConfigurationImpl.class)
	private List<APNConfiguration> apnConfiguration;

    public APNConfigurationListWrapperImpl() {
    }

    public APNConfigurationListWrapperImpl(List<APNConfiguration> apnConfiguration) {
