...
public class CSGSubscriptionDataListWrapperImpl {
	
	@ASNProperty(asnClass=ASNClass.UNIVERSAL,tag=16,constructed=true,index=-1,defaultImplementation = CSGSubscriptionDataImpl.class)
	private List<CSGSubscriptionData> csgSubscriptionData;

    public CSGSubscriptionDataListWrapperImpl() {
    }

    public CSGSubscriptionDataListWrapperImpl(List<CSGSubscriptionData> csgSubscriptionData) {
