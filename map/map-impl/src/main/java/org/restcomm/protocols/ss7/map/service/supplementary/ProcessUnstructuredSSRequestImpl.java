...
public class ProcessUnstructuredSSRequestImpl extends SupplementaryMessageImpl implements ProcessUnstructuredSSRequest {
	...
	public void validateElement() throws ASNParsingComponentException {
		if(ussdDataCodingSch==null)
			throw new ASNParsingComponentException("ussd data coding sch should be set for process unstructured SS request", ASNParsingComponentExceptionReason.MistypedRootParameter);

		if(ussdString==null)
			throw new ASNParsingComponentException("ussd string should be set for process unstructured SS request", ASNParsingComponentExceptionReason.MistypedRootParameter);
	}
}
