...
public class ExternalClientIDListWrapperImpl {
	...
	@ASNProperty(asnClass=ASNClass.UNIVERSAL,tag=16,constructed=true,index=-1,defaultImplementation = ExternalClientImpl.class)
	private List<ExternalClient> externalClient;

    public ExternalClientIDListWrapperImpl() {
    }

    public ExternalClientIDListWrapperImpl(List<ExternalClient> externalClient) {
