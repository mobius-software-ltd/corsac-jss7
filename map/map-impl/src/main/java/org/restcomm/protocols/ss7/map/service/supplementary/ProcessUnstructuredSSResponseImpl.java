...
public class ProcessUnstructuredSSResponseImpl extends SupplementaryMessageImpl implements ProcessUnstructuredSSResponse {
	...
	public void validateElement() throws ASNParsingComponentException {
		if(ussdDataCodingSch==null)
			throw new ASNParsingComponentException("ussd data coding sch should be set for process unstructured SS response", ASNParsingComponentExceptionReason.MistypedRootParameter);

		if(ussdString==null)
			throw new ASNParsingComponentException("ussd string should be set for process unstructured SS response", ASNParsingComponentExceptionReason.MistypedRootParameter);
	}
}
