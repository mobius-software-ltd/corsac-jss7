...
public class TChangeOfPositionSpecificInfoImpl implements TChangeOfPositionSpecificInfo {
    ...
    public TChangeOfPositionSpecificInfoImpl(LocationInformation locationInformation, List<MetDPCriterion> metDPCriteriaList) {
