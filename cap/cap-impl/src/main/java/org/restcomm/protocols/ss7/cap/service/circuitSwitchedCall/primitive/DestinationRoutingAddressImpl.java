...
public class DestinationRoutingAddressImpl implements DestinationRoutingAddress {
	@ASNProperty(asnClass = ASNClass.UNIVERSAL,tag = 4,constructed = false,index = -1,defaultImplementation = CalledPartyNumberCapImpl.class)
	public List<CalledPartyNumberCap> calledPartyNumber;

    public DestinationRoutingAddressImpl() {
    }

    public DestinationRoutingAddressImpl(List<CalledPartyNumberCap> calledPartyNumber) {
        this.calledPartyNumber = calledPartyNumber;
    }

    public List<CalledPartyNumberCap> getCalledPartyNumber() {
