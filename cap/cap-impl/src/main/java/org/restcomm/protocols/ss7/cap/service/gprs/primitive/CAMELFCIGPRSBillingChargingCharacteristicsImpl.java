...
public class CAMELFCIGPRSBillingChargingCharacteristicsImpl implements CAMELFCIGPRSBillingChargingCharacteristics {
	@ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 0,constructed = true,index = -1, defaultImplementation = FCIBCCCAMELSequence1GprsImpl.class)
    ...
    public String toString() {
        ...
        sb.append("CAMELFCIGPRSBillingChargingCharacteristics [");
	...
	public void validateElement() throws ASNParsingComponentException {
		if(fcIBCCCAMELsequence1==null)
			throw new ASNParsingComponentException("fcibcc CAMEL sequence 1 should be set for CAMEL fci gprs billing charging characteristics", ASNParsingComponentExceptionReason.MistypedParameter);			
	}
}
