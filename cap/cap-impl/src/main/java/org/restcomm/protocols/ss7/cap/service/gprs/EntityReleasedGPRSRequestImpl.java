...
public class EntityReleasedGPRSRequestImpl extends GprsMessageImpl implements EntityReleasedGPRSRequest {
    ...
    public String toString() {
        ...
        sb.append("EntityReleasedGPRSRequest [");
	...
	public void validateElement() throws ASNParsingComponentException {
		if(gprsCause==null)
			throw new ASNParsingComponentException("gprs cause should be set for entity released gprs request", ASNParsingComponentExceptionReason.MistypedRootParameter);			
	}
}