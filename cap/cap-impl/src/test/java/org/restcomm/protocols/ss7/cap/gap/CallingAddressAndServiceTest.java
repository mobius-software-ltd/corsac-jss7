...
public class CallingAddressAndServiceTest {
    ...
    public void testDecode() throws Exception {
        ...
        assertTrue(ByteBufUtil.equals(DigitsIsupImpl.translate(elem.getCallingAddressDigits().getGenericDigits()),Unpooled.wrappedBuffer(getDigitsData())));
    ...
    public void testEncode() throws Exception {
        ...
        DigitsIsupImpl callingAddressValue = new DigitsIsupImpl(new GenericDigitsImpl(Unpooled.wrappedBuffer(getDigitsData())));
