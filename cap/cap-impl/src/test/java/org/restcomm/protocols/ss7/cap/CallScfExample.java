			...
			if (this.cc != null)
				...
				case initialDPRecieved:
					...
					if (newNumber != null) {
						...
						CalledPartyNumberIsup cpnc = this.capProvider.getCAPParameterFactory()
						...
						currentCapDialog.addConnectRequest(destinationRoutingAddress, null, null, null, null, null,
