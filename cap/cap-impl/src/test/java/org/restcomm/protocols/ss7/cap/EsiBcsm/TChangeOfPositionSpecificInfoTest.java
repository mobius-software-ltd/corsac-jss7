...
public class TChangeOfPositionSpecificInfoTest {
    ...
    public void testDecode() throws Exception {
    	...
    	parser.replaceClass(TChangeOfPositionSpecificInfoImpl.class);
    	
    	byte[] rawData = this.getData1();
        ASNDecodeResult result=parser.decode(Unpooled.wrappedBuffer(rawData));

        assertFalse(result.getHadErrors());
        assertTrue(result.getResult() instanceof TChangeOfPositionSpecificInfoImpl);
        
        TChangeOfPositionSpecificInfoImpl elem = (TChangeOfPositionSpecificInfoImpl)result.getResult();                
        ...
        elem = (TChangeOfPositionSpecificInfoImpl)result.getResult();
        assertEquals((int) elem.getLocationInformation().getAgeOfLocationInformation(), 200);
