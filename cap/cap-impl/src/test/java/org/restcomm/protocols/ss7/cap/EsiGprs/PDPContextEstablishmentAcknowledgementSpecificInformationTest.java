...
public class PDPContextEstablishmentAcknowledgementSpecificInformationTest {
    ...
    public byte[] getData() {
        return new byte[] { 48, -127, -106, -128, 3, 52, 20, 30, -127, 4, 41, 42, 43, 44, -94, 57, -96, 7, -127, 5, 82, 
        		-16, 16, 17, 92, -127, 6, 11, 12, 13, 14, 15, 16, -126, 8, 16, 32, 33, 34, 35, 36, 37, 38, -125, 4, -111, 
        		86, 52, 18, -124, 3, 91, 92, 93, -122, 0, -121, 10, 1, 16, 3, 4, 5, 6, 7, 8, 9, 10, -120, 0, -119, 1, 13, 
        		-93, 11, -128, 1, -15, -127, 1, 1, -126, 3, 4, 7, 7, -92, 48, -96, 5, -128, 3, 4, 7, 7, -95, 11, -127, 9, 1, 
        		0, 0, 0, 0, 0, 0, 0, 0, -94, 5, -128, 3, 4, 7, 7, -93, 5, -128, 3, 0, 0, 0, -92, 5, -128, 3, 16, 0, 0, -91, 5, 
        		-128, 3, 17, 0, 0, -123, 8, 2, 17, 33, 3, 1, 112, -127, 35, -122, 5, 4, 1, 1, 1, 1 };
    };
    ...
    public void testDecode() throws Exception {
    	...
    	parser.replaceClass(PDPContextEstablishmentAcknowledgementSpecificInformationImpl.class);
    	
    	byte[] rawData = this.getData();
        ASNDecodeResult result=parser.decode(Unpooled.wrappedBuffer(rawData));

        assertFalse(result.getHadErrors());
        assertTrue(result.getResult() instanceof PDPContextEstablishmentAcknowledgementSpecificInformationImpl);
        
        PDPContextEstablishmentAcknowledgementSpecificInformationImpl prim = (PDPContextEstablishmentAcknowledgementSpecificInformationImpl)result.getResult();                        
