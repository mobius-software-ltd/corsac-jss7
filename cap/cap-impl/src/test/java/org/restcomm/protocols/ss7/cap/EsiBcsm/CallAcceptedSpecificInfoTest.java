...
public class CallAcceptedSpecificInfoTest {
    ...
    public void testDecode() throws Exception {
    	...
    	parser.replaceClass(CallAcceptedSpecificInfoImpl.class);
    	
    	byte[] rawData = this.getData1();
        ASNDecodeResult result=parser.decode(Unpooled.wrappedBuffer(rawData));

        assertFalse(result.getHadErrors());
        assertTrue(result.getResult() instanceof CallAcceptedSpecificInfoImpl);
        
        CallAcceptedSpecificInfoImpl elem = (CallAcceptedSpecificInfoImpl)result.getResult();                        
