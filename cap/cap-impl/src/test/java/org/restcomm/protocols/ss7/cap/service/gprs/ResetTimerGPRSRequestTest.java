...
public class ResetTimerGPRSRequestTest {
    ...
    public void testDecode() throws Exception {
    	...
    	parser.replaceClass(ResetTimerGPRSRequestImpl.class);
    	
    	byte[] rawData = this.getData();
        ASNDecodeResult result=parser.decode(Unpooled.wrappedBuffer(rawData));

        assertFalse(result.getHadErrors());
        assertTrue(result.getResult() instanceof ResetTimerGPRSRequestImpl);
        
        ResetTimerGPRSRequestImpl prim = (ResetTimerGPRSRequestImpl)result.getResult();        
