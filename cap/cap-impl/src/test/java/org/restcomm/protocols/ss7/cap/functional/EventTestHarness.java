...
public class EventTestHarness implements CAPDialogListener, CAPServiceCircuitSwitchedCallListener,
	...
	public void onPromptAndCollectUserInformationResponse(PromptAndCollectUserInformationResponse ind) {
		...
		TestEvent te = TestEvent.createReceivedEvent(EventType.PromptAndCollectUserInformationResponse, ind,
				sequence++);
		this.observerdEvents.add(te);
	}
	...
	public void onDisconnectForwardConnectionWithArgumentRequest(DisconnectForwardConnectionWithArgumentRequest ind) {
		...
		TestEvent te = TestEvent.createReceivedEvent(EventType.DisconnectForwardConnectionWithArgumentRequest, ind,
				sequence++);
		this.observerdEvents.add(te);
	}
