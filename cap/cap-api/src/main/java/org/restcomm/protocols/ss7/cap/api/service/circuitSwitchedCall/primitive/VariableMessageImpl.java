...
public class VariableMessageImpl {
    ...
    public VariableMessageImpl(int elementaryMessageID, List<VariablePartImpl> variableParts) {
    ...
    public List<VariablePartImpl> getVariableParts() {
    	if(variableParts==null)
    		return null;
    ...
    public String toString() {
        ...
        if (this.variableParts != null && this.variableParts.getVariablePart()!=null) {
            ...
            for (VariablePartImpl val : this.variableParts.getVariablePart()) {
                if (val != null) {
