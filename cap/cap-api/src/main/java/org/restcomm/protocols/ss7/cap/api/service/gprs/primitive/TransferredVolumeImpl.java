...
public class TransferredVolumeImpl {
	@ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 0,constructed = false,index = -1)
    private ASNInteger volumeIfNoTariffSwitch;
    
    @ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 1,constructed = true,index = -1)
    private VolumeIfTariffSwitchImpl volumeIfTariffSwitch;
    ...
    public TransferredVolumeImpl(VolumeIfTariffSwitchImpl volumeIfTariffSwitch) {
    ...
    public VolumeIfTariffSwitchImpl getVolumeIfTariffSwitch() {
