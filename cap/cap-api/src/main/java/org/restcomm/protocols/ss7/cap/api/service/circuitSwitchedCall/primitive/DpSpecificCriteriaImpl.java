...
public class DpSpecificCriteriaImpl {
	@ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 1,constructed = false,index = -1)
    private ASNInteger applicationTimer;

    @ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 2,constructed = true,index = -1)
    private MidCallControlInfoImpl midCallControlInfo;

    @ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 3,constructed = true,index = -1)
    private DpSpecificCriteriaAltImpl dpSpecificCriteriaAlt;
    ...
    public DpSpecificCriteriaImpl(MidCallControlInfoImpl midCallControlInfo) {
        this.midCallControlInfo = midCallControlInfo;
    }

    public DpSpecificCriteriaImpl(DpSpecificCriteriaAltImpl dpSpecificCriteriaAlt) {
    ...
    public MidCallControlInfoImpl getMidCallControlInfo() {    	
        return midCallControlInfo;
    }

    public DpSpecificCriteriaAltImpl getDpSpecificCriteriaAlt() {
