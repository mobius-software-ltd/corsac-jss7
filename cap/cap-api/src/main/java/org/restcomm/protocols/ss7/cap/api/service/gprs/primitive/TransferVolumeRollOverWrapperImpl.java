...
public class TransferVolumeRollOverWrapperImpl {
	@ASNChoise
	private TransferredVolumeRollOverImpl transferredVolumeRollOver;

    public TransferVolumeRollOverWrapperImpl() {
    }

    public TransferVolumeRollOverWrapperImpl(TransferredVolumeRollOverImpl transferredVolumeRollOver) {
