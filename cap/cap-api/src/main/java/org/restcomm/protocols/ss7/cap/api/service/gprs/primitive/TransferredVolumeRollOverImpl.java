...
public class TransferredVolumeRollOverImpl {
	@ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 0,constructed = false,index = -1)
    private ASNInteger roVolumeIfNoTariffSwitch;
    
    @ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 1,constructed = true,index = -1)
    private ROVolumeIfTariffSwitchImpl roVolumeIfTariffSwitch;
    ...
    public TransferredVolumeRollOverImpl(ROVolumeIfTariffSwitchImpl roVolumeIfTariffSwitch) {
    ...
    public ROVolumeIfTariffSwitchImpl getROVolumeIfTariffSwitch() {
