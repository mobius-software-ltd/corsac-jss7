...
public class RequestedInformationValueImpl {
    ...
    private DateAndTimeImpl callStopTimeValue;
    ...
    private CauseCapImpl releaseCauseValue;
    ...
    public RequestedInformationValueImpl(DateAndTimeImpl callStopTimeValue) {
        this.callStopTimeValue = callStopTimeValue;
    }

    public RequestedInformationValueImpl(CauseCapImpl releaseCauseValue) {
