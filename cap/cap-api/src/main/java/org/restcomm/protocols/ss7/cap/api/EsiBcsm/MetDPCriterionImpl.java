...
public class MetDPCriterionImpl {
    ...
    private CellGlobalIdOrServiceAreaIdFixedLengthImpl leavingCellGlobalId;
    
    @ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 2,constructed = false,index = -1)
    private CellGlobalIdOrServiceAreaIdFixedLengthImpl enteringServiceAreaId;
    
    @ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 3,constructed = false,index = -1)
    private CellGlobalIdOrServiceAreaIdFixedLengthImpl leavingServiceAreaId;
    
    @ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 4,constructed = false,index = -1)
    private LAIFixedLengthImpl enteringLocationAreaId;
    
    @ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 5,constructed = false,index = -1)
    private LAIFixedLengthImpl leavingLocationAreaId;
    ...
    private MetDPCriterionAltImpl metDPCriterionAlt;

    public MetDPCriterionImpl() {
    }

    public MetDPCriterionImpl(CellGlobalIdOrServiceAreaIdFixedLengthImpl value, CellGlobalIdOrServiceAreaIdFixedLength_Option option) {
        switch (option) {
    ...
    public MetDPCriterionImpl(LAIFixedLengthImpl value, LAIFixedLength_Option option) {
        switch (option) {
    ...
    public MetDPCriterionImpl(MetDPCriterionAltImpl metDPCriterionAlt) {
        this.metDPCriterionAlt = metDPCriterionAlt;
    }

    public CellGlobalIdOrServiceAreaIdFixedLengthImpl getEnteringCellGlobalId() {
        return enteringCellGlobalId;
    }

    public CellGlobalIdOrServiceAreaIdFixedLengthImpl getLeavingCellGlobalId() {
        return leavingCellGlobalId;
    }

    public CellGlobalIdOrServiceAreaIdFixedLengthImpl getEnteringServiceAreaId() {
        return enteringServiceAreaId;
    }

    public CellGlobalIdOrServiceAreaIdFixedLengthImpl getLeavingServiceAreaId() {
        return leavingServiceAreaId;
    }

    public LAIFixedLengthImpl getEnteringLocationAreaId() {
        return enteringLocationAreaId;
    }

    public LAIFixedLengthImpl getLeavingLocationAreaId() {
    ...
    public MetDPCriterionAltImpl getMetDPCriterionAlt() {
