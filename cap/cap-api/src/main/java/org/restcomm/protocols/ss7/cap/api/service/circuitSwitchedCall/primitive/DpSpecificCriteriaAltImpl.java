...
public class DpSpecificCriteriaAltImpl {
    ...
    public DpSpecificCriteriaAltImpl(List<ChangeOfLocationImpl> changeOfPositionControlInfo, Integer numberOfDigits) {
    ...
    public List<ChangeOfLocationImpl> getChangeOfPositionControlInfo() {
        if(changeOfPositionControlInfo==null)
        	return null;
    ...
    public String toString() {
        ...
        if (this.changeOfPositionControlInfo != null && this.changeOfPositionControlInfo.getChangeOfLocationList() != null) {
            ...
            for (ChangeOfLocationImpl be : this.changeOfPositionControlInfo.getChangeOfLocationList()) {
                if (firstItem)
                    firstItem = false;
                else
                    sb.append(", ");
