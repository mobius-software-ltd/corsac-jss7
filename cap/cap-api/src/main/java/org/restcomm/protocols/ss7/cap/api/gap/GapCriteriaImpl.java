...
public class GapCriteriaImpl {
	@ASNChoise
	private BasicGapCriteriaImpl basicGapCriteria;
    private CompoundCriteriaImpl compoundCriteria;

    public GapCriteriaImpl() {
    }

    public GapCriteriaImpl(BasicGapCriteriaImpl basicGapCriteria) {
        this.basicGapCriteria = basicGapCriteria;
    }

    public GapCriteriaImpl(CompoundCriteriaImpl compoundCriteria) {
    ...
    public CompoundCriteriaImpl getCompoundGapCriteria() {
