...
public class AOCSubsequentImpl {
	@ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 0,constructed = true,index = -1)
    private CAI_GSM0224Impl cai_GSM0224;
    ...
    public AOCSubsequentImpl(CAI_GSM0224Impl cai_GSM0224, Integer tariffSwitchInterval) {
    ...
    public CAI_GSM0224Impl getCAI_GSM0224() {
        return cai_GSM0224;
    }
