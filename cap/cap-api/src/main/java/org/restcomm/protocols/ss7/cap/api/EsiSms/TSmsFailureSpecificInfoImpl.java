...
public class TSmsFailureSpecificInfoImpl {
	@ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 0,constructed = false,index = -1)
    private MTSMSCauseImpl failureCause;

    public TSmsFailureSpecificInfoImpl() {
    }

    public TSmsFailureSpecificInfoImpl(MTSMSCauseImpl failureCause) {
        this.failureCause = failureCause;
    }

    public MTSMSCauseImpl getFailureCause() {
