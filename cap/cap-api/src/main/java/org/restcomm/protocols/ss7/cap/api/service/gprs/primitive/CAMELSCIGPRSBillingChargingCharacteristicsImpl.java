...
public class CAMELSCIGPRSBillingChargingCharacteristicsImpl {
	@ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 0,constructed = true,index = -1)
    private AOCGPRSImpl aocGPRS;
    ...
    public CAMELSCIGPRSBillingChargingCharacteristicsImpl(AOCGPRSImpl aocGPRS, PDPIDImpl pdpID) {
        this.aocGPRS = aocGPRS;
        this.pdpID = pdpID;
    }

    public AOCGPRSImpl getAOCGPRS() {
        return this.aocGPRS;
    }
