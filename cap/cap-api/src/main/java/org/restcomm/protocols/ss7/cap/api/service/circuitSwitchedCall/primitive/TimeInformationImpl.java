...
public class TimeInformationImpl {
	@ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 0,constructed = false,index = -1)
    private ASNInteger timeIfNoTariffSwitch;
    
    @ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 1,constructed = true,index = -1)
    private TimeIfTariffSwitchImpl timeIfTariffSwitch;
    ...
    public TimeInformationImpl(TimeIfTariffSwitchImpl timeIfTariffSwitch) {
    ...
    public TimeIfTariffSwitchImpl getTimeIfTariffSwitch() {
