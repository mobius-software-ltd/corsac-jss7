...
public class SCIBillingChargingCharacteristicsImpl {
	@ASNChoise
    ...
    public SCIBillingChargingCharacteristicsImpl(AOCBeforeAnswerImpl aocBeforeAnswer) {
        this.camelSCIBillingChargingCharacteristicsImpl = new CamelSCIBillingChargingCharacteristicsImpl(aocBeforeAnswer);
    }

    public SCIBillingChargingCharacteristicsImpl(AOCSubsequentImpl aocSubsequent) {
        this.camelSCIBillingChargingCharacteristicsImpl = new CamelSCIBillingChargingCharacteristicsImpl(aocSubsequent);
    }

    public SCIBillingChargingCharacteristicsImpl(CAMELSCIBillingChargingCharacteristicsAltImpl aocExtension) {
