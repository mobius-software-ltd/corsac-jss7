...
public class ElapsedTimeRollOverImpl {
	@ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 0,constructed = false,index = -1)
    public ASNInteger roTimeGPRSIfNoTariffSwitch;
    
    @ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 1,constructed = true,index = -1)
    public ROTimeGPRSIfTariffSwitchImpl roTimeGPRSIfTariffSwitch;
    ...
    public ElapsedTimeRollOverImpl(ROTimeGPRSIfTariffSwitchImpl roTimeGPRSIfTariffSwitch) {
    ...
    public ROTimeGPRSIfTariffSwitchImpl getROTimeGPRSIfTariffSwitch() {
