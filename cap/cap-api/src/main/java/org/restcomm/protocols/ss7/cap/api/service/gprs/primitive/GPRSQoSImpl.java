...
public class GPRSQoSImpl {
    ...
    private QoSSubscribedImpl shortQoSFormat;
    
    @ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 1,constructed = false,index = -1)
    private ExtQoSSubscribedImpl longQoSFormat;

    public GPRSQoSImpl() {

    }

    public GPRSQoSImpl(QoSSubscribedImpl shortQoSFormat) {
        this.shortQoSFormat = shortQoSFormat;
    }

    public GPRSQoSImpl(ExtQoSSubscribedImpl longQoSFormat) {
        this.longQoSFormat = longQoSFormat;
    }

    public QoSSubscribedImpl getShortQoSFormat() {
        return this.shortQoSFormat;
    }

    public ExtQoSSubscribedImpl getLongQoSFormat() {
