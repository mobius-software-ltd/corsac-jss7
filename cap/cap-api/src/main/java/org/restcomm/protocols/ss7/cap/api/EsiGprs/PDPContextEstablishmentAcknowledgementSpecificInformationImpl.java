...
public class PDPContextEstablishmentAcknowledgementSpecificInformationImpl {
    ...
    public PDPContextEstablishmentAcknowledgementSpecificInformationImpl(AccessPointNameImpl accessPointName,
            GPRSChargingIDImpl chargingID, LocationInformationGPRSImpl locationInformationGPRS, EndUserAddressImpl endUserAddress,
            QualityOfServiceImpl qualityOfService, TimeAndTimezoneImpl timeAndTimezone, GSNAddressImpl gsnAddress) {
