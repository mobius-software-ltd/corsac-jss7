...
public class OChangeOfPositionSpecificInfoImpl {
    ...
    public OChangeOfPositionSpecificInfoImpl(LocationInformationImpl locationInformation, List<MetDPCriterionImpl> metDPCriteriaList) {
