...
public class GPRSQoSExtensionImpl {
	@ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 0,constructed = false,index = -1)
    private Ext2QoSSubscribedImpl supplementToLongQoSFormat;

    public GPRSQoSExtensionImpl() {
    }

    public GPRSQoSExtensionImpl(Ext2QoSSubscribedImpl supplementToLongQoSFormat) {
        this.supplementToLongQoSFormat = supplementToLongQoSFormat;
    }

    public void setSupplementToLongQoSFormat(Ext2QoSSubscribedImpl supplementToLongQoSFormat) {
        this.supplementToLongQoSFormat = supplementToLongQoSFormat;
    }

    public Ext2QoSSubscribedImpl getSupplementToLongQoSFormat() {
