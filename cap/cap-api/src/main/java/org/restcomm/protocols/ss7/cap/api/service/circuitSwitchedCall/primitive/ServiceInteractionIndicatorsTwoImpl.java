...
public class ServiceInteractionIndicatorsTwoImpl {
	@ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 0,constructed = true,index = -1)
    private ForwardServiceInteractionIndImpl forwardServiceInteractionInd;
    
    @ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 1,constructed = true,index = -1)
    private BackwardServiceInteractionIndImpl backwardServiceInteractionInd;
    ...
    public ServiceInteractionIndicatorsTwoImpl(ForwardServiceInteractionIndImpl forwardServiceInteractionInd,
    ...
    public ForwardServiceInteractionIndImpl getForwardServiceInteractionInd() {
        return forwardServiceInteractionInd;
    }

    public BackwardServiceInteractionIndImpl getBackwardServiceInteractionInd() {
