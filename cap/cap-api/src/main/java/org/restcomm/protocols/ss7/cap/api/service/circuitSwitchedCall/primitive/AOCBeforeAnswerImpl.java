...
public class AOCBeforeAnswerImpl {
	@ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 0,constructed = true,index = -1)
    private CAI_GSM0224Impl aocInitial;
    ...
    public AOCBeforeAnswerImpl(CAI_GSM0224Impl aocInitial, AOCSubsequentImpl aocSubsequent) {
        this.aocInitial = aocInitial;
        this.aocSubsequent = aocSubsequent;
    }

    public CAI_GSM0224Impl getAOCInitial() {
        return aocInitial;
    }
