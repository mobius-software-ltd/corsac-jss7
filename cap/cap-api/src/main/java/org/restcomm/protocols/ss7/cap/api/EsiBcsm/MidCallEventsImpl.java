...
public class MidCallEventsImpl {
	@ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 3,constructed = false, index = -1)
    private DigitsImpl dtmfDigitsCompleted;
    
    @ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 4,constructed = false, index = -1)
    private DigitsImpl dtmfDigitsTimeOut;

    public MidCallEventsImpl() {
    }

    public MidCallEventsImpl(DigitsImpl dtmfDigits, boolean isDtmfDigitsCompleted) {
