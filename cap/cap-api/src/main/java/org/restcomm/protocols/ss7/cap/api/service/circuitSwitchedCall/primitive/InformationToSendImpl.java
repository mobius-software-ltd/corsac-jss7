...
public class InformationToSendImpl {
    ...
    private InbandInfoImpl inbandInfo;
    
    @ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 1,constructed = true,index = -1)
    private ToneImpl tone;

    public InformationToSendImpl() {
    }

    public InformationToSendImpl(InbandInfoImpl inbandInfo) {
        this.inbandInfo = inbandInfo;
    }

    public InformationToSendImpl(ToneImpl tone) {
        this.tone = tone;
    }

    public InbandInfoImpl getInbandInfo() {
        return inbandInfo;
    }

    public ToneImpl getTone() {
        return tone;
    }
