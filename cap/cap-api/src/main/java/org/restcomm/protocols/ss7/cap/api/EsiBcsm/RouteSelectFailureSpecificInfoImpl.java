...
public class RouteSelectFailureSpecificInfoImpl {
	@ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 0,constructed = false,index = -1)
    private CauseCapImpl failureCause;

    public RouteSelectFailureSpecificInfoImpl() {
    }

    public RouteSelectFailureSpecificInfoImpl(CauseCapImpl failureCause) {
        this.failureCause = failureCause;
    }

    public CauseCapImpl getFailureCause() {
        return failureCause;
    }
