...
public class OCalledPartyBusySpecificInfoImpl {
	@ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 0,constructed = false,index = -1)
    private CauseCapImpl busyCause;

    public OCalledPartyBusySpecificInfoImpl() {        
    }

    public OCalledPartyBusySpecificInfoImpl(CauseCapImpl busyCause) {
        this.busyCause = busyCause;
    }

    public CauseCapImpl getBusyCause() {
        return busyCause;
    }
