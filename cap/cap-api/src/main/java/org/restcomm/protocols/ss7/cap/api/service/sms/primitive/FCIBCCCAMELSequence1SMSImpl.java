...
public class FCIBCCCAMELSequence1SMSImpl {
	@ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 0,constructed = false,index = -1)
    private FreeFormatDataSMSImpl freeFormatData;
    ...
    public FCIBCCCAMELSequence1SMSImpl(FreeFormatDataSMSImpl freeFormatData, AppendFreeFormatData appendFreeFormatData) {
    ...
    public FreeFormatDataSMSImpl getFreeFormatData() {
