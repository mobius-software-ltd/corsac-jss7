...
public class ContinueWithArgumentArgExtensionImpl {
    ...
    public ContinueWithArgumentArgExtensionImpl(boolean suppressDCSI, boolean suppressNCSI,
            boolean suppressOutgoingCallBarring, LegOrCallSegmentImpl legOrCallSegment) {
        if(suppressDCSI)
    ...
    public LegOrCallSegmentImpl getLegOrCallSegment() {
    	if(legOrCallSegment==null)
    		return null;
