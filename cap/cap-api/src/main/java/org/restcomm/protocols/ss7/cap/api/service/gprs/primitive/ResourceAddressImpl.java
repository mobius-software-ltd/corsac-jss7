...
public class ResourceAddressImpl {
    ...
    private CalledPartyNumberCapImpl ipRoutingAddress;
    ...
    public ResourceAddressImpl(CalledPartyNumberCapImpl ipRoutingAddress) {
    	this.ipRoutingAddress = ipRoutingAddress;
    }

    public CalledPartyNumberCapImpl getIPRoutingAddress() {
