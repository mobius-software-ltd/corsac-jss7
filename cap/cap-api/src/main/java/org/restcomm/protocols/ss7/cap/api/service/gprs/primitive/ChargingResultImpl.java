...
public class ChargingResultImpl {
    ...
    private TransferVolumeWrapperImpl transferredVolume;
    ...
    public ChargingResultImpl(TransferredVolumeImpl transferredVolume) {
    	if(transferredVolume!=null)
    		this.transferredVolume = new TransferVolumeWrapperImpl(transferredVolume);
    }

    public ChargingResultImpl(ElapsedTimeImpl elapsedTime) {
    	if(elapsedTime!=null)
    		this.elapsedTime = new ElapsedTimeWrapperImpl(elapsedTime);
    }

    public TransferredVolumeImpl getTransferredVolume() {
    	if(transferredVolume==null)
    		return null;
    ...
    public ElapsedTimeImpl getElapsedTime() {
    	if(elapsedTime==null)
    		return null;
