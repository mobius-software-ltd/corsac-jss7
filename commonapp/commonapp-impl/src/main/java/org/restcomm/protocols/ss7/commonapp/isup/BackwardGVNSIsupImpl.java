 ...
 *
 */
public class BackwardGVNSIsupImpl extends ASNOctetString implements ForwardGVNSIsup {
	public BackwardGVNSIsupImpl() {
		super("ForwardGVNSIsup",null,null,false);
    }

    public BackwardGVNSIsupImpl(BackwardGVNS backwardGVNS) throws ASNParsingException {
        super(translate(backwardGVNS),"BackwardGVNSIsup",null,null,false);
    }

    public static ByteBuf translate(BackwardGVNS backwardGVNS) throws ASNParsingException {
        if (backwardGVNS == null)
            throw new ASNParsingException("The backwardGVNS parameter must not be null");
        try {
        	ByteBuf buffer=Unpooled.buffer();
        	((BackwardGVNSImpl) backwardGVNS).encode(buffer);
            return buffer;
