...
public class RAIdentityListWrapperImpl {
	...
	@ASNProperty(asnClass=ASNClass.UNIVERSAL,tag=4,constructed=false,index=-1,defaultImplementation = RAIdentityImpl.class)
	private List<RAIdentity> raIdentityList;

    public RAIdentityListWrapperImpl() {
    }

    public RAIdentityListWrapperImpl(List<RAIdentity> raIdentityList) {
        this.raIdentityList = raIdentityList;
    }

    public List<RAIdentity> getRAIdentityList() {
