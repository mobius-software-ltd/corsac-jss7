...
public class BearerCapabilityImpl implements BearerCapability {
	@ASNProperty(asnClass = ASNClass.CONTEXT_SPECIFIC,tag = 0,constructed = false,index = -1,defaultImplementation = BearerIsupImpl.class)
    private BearerIsup bearerCap;

    public BearerCapabilityImpl() {
    }

    public BearerCapabilityImpl(BearerIsup bearerCap) {
        this.bearerCap = bearerCap;
    }

    public void setBearerCap(BearerIsup bearerCap) {
        this.bearerCap = bearerCap;
    }

    public BearerIsup getBearerCap() {
        return bearerCap;
    }
