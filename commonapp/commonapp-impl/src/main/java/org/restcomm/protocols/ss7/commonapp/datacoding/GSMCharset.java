...
public class GSMCharset {
    ...
    public GSMCharset() {
        this(basicMap,basicExtentionMap);
    }

    public GSMCharset(int[] mainTable, int[] extentionTable) {
        this.mainTable = mainTable;
        this.extensionTable = extentionTable;
    }

    public GSMCharset(NationalLanguageIdentifier nationalLanguageLockingShiftIdentifier,
    ...
    public GSMCharsetDecoder newDecoder() {
        return new GSMCharsetDecoder(this);
    }

    public GSMCharsetEncoder newEncoder() {
    ...
    public static GSMCharset gsm7CharsetDefault = new GSMCharset(basicMap,basicExtentionMap);
    ...
    public static GSMCharset gsm7CharsetSpanish = new GSMCharset(basicMap,spanishExtentionMap);
    ...
    public static GSMCharset gsm7CharsetPortugese = new GSMCharset(portugeseMap,portugeseExtentionMap);
    ...
    public static GSMCharset gsm7CharsetTurkish = new GSMCharset(turkishMap,turkishExtentionMap);
    ...
    public static GSMCharset gsm7CharsetUrdu = new GSMCharset(urduMap, urduExtentionMap);
    ...
    public static GSMCharset gsm7CharsetHindi = new GSMCharset(hindiMap, hindiExtentionMap);
    ...
    public static GSMCharset gsm7CharsetBengali = new GSMCharset(bengaliMap, bengaliExtentionMap);
    ...
    public static GSMCharset gsm7CharsetPunjabi = new GSMCharset(punjabiMap, punjabiExtentionMap);
    ...
    public static GSMCharset gsm7CharsetGujarati = new GSMCharset(gujaratiMap, gujaratiExtentionMap);
    ...
    public static GSMCharset gsm7CharsetOriya = new GSMCharset(oriyaMap, oriyaExtentionMap);
    ...
    public static GSMCharset gsm7CharsetTamil = new GSMCharset(tamilMap, tamilExtentionMap);
    ...
    public static GSMCharset gsm7CharsetTelugu = new GSMCharset(teluguMap, teluguExtentionMap);
    ...
    public static GSMCharset gsm7CharsetKannada = new GSMCharset(kannadaMap, kannadaExtentionMap);
    ...
    public static GSMCharset gsm7CharsetMalayalam = new GSMCharset(malayalamMap, malayalamExtentionMap);
}