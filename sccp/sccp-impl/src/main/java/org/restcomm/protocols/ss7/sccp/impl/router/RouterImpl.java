...
public class RouterImpl implements Router {
	...
	@Override
	public void modifyLongMessageRule(int id, Integer firstSpc, Integer lastSpc, LongMessageRuleType ruleType)
			throws Exception {
	...
	@Override
	public void addMtp3ServiceAccessPoint(int id, int mtp3Id, int opc, int ni, int networkId, String localGtDigits)
			throws Exception {
	...
	@Override
	public void modifyMtp3ServiceAccessPoint(int id, int mtp3Id, int opc, int ni, int networkId, String localGtDigits)
			throws Exception {
		if (this.getMtp3ServiceAccessPoint(id) == null)
			throw new Exception(String.format(SccpOAMMessage.SAP_DOESNT_EXIST, name));
	...
	public void modifyMtp3ServiceAccessPoint(int id, Integer mtp3Id, Integer opc, Integer ni, Integer networkId,
		...
		Mtp3ServiceAccessPointImpl newSap = new Mtp3ServiceAccessPointImpl(mtp3Id, opc, ni, this.name, networkId,
				localGtDigits);
