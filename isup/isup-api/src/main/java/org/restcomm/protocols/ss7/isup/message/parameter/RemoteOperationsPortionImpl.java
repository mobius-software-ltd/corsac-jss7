...
public class RemoteOperationsPortionImpl {

	@ASNWildcard
	List<RemoteOperationImpl> components;

	public List<RemoteOperationImpl> getComponents() {
		return components;
	}

	public void setComponents(List<RemoteOperationImpl> components) {
