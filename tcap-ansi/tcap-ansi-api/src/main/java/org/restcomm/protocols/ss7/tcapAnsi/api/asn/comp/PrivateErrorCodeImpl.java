...
@ASNTag(asnClass=ASNClass.PRIVATE,tag=20,constructed=false,lengthIndefinite=false)
public class PrivateErrorCodeImpl extends ASNInteger implements ErrorCode {
