 ...
 *
 */
@ASNTag(asnClass=ASNClass.PRIVATE,tag=28,constructed=false,lengthIndefinite=false)
public class ObjectApplicationContextNameImpl extends ASNObjectIdentifier implements ApplicationContext {
