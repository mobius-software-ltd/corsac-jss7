...
public class TCAPAbnormalTest extends SccpHarness {
	...
	public void setUp() throws Exception {
		...
		this.tcapStack1 = new TCAPStackImpl("TCAPAbnormalTest_1", this.sccpProvider1, 8, workerPool.getPeriodicQueue());
		this.tcapStack2 = new TCAPStackImpl("TCAPAbnormalTest_2", this.sccpProvider2, 8, workerPool.getPeriodicQueue());
