...
public class DialogIdleTest extends SccpHarness {
	...
	public void setUp() throws Exception {
		...
		this.tcapStack1 = new TCAPStackImpl("DialogIdleTest_1", this.sccpProvider1, 8, workerPool.getPeriodicQueue());
		this.tcapStack2 = new TCAPStackImpl("DialogIdleTest_2", this.sccpProvider2, 8, workerPool.getPeriodicQueue());
