...
public class ParseMessageDraftTest {
	...
	private byte[] dataTcQuery = new byte[] { (byte) 0xe2, 0x35, (byte) 0xc7, 0x04, 0x00, 0x00, 0x01, 0x00, (byte) 0xe8,
			0x2d, (byte) 0xe9, 0x2b, (byte) 0xcf, 0x01, 0x00, (byte) 0xd1, 0x02, 0x09, 0x35, (byte) 0xf2, 0x22, 4, 32,
			(byte) 0x9f, 0x69, 0x00, (byte) 0x9f, 0x74, 0x00, (byte) 0x9f, (byte) 0x81, 0x00, 0x01, 0x08, (byte) 0x88,
			0x05, 0x16, 0x19, 0x32, 0x04, 0x00, (byte) 0x9f, (byte) 0x81, 0x41, 0x01, 0x01, (byte) 0x9f, (byte) 0x81,
			0x43, 0x05, 0x22, 0x22, 0x22, 0x22, 0x22 };

	private byte[] dataTcConversation = new byte[] { -27, 30, -57, 8, 1, 1, 2, 2, 3, 3, 4, 4, -24, 18, -23, 16, -49, 1,
			0, -47, 2, 9, 53, -14, 7, 1, 2, 3, 4, 5, 6, 7 };

	private byte[] dataTcResponse = { (byte) 0xe4, 0x3e, (byte) 0xc7, 0x04, 0x14, 0x00, 0x00, 0x00, (byte) 0xe8, 0x36,
			(byte) 0xea, 0x34, (byte) 0xcf, 0x01, 0x01, (byte) 0xf2, 0x2f, 0x04, 0x2d, (byte) 0x96, 0x01, 0x13,
			(byte) 0x8e, 0x02, 0x06, 0x00, (byte) 0x95, 0x03, 0x00, 0x0c, 0x10, (byte) 0x9f, 0x4e, 0x01, 0x01,
			(byte) 0x99, 0x03, 0x7a, 0x0d, 0x11, (byte) 0x9f, 0x5d, 0x07, 0x00, 0x00, 0x21, 0x06, 0x36, 0x54, 0x10,
			(byte) 0x97, 0x01, 0x07, (byte) 0x9f, 0x73, 0x01, 0x00, (byte) 0x9f, 0x75, 0x01, 0x00, (byte) 0x98, 0x01,
			0x02 };

	private byte[] dataTcAbort = new byte[] { -10, 28, -57, 4, 20, 0, 0, 0, -8, 20, 40, 18, 6, 7, 4, 0, 0, 1, 1, 1, 1,
			-96, 7, 1, 2, 3, 4, 5, 6, 7 };

	private byte[] dataTcUnidirectional = new byte[] { -31, 22, -57, 0, -24, 18, -23, 16, -49, 1, 0, -47, 2, 9, 53, -14,
			7, 1, 2, 3, 4, 5, 6, 7 };
	...
	public void testTCQuery() throws IOException, ParseException {
		...
		assertEquals(Utils.decodeTransactionId(msg.getMessage().getOriginatingTransactionId(), true), 256);
	...
	public void testTCConversation() throws IOException, ParseException {
		...
		assertEquals(Utils.decodeTransactionId(msg.getMessage().getOriginatingTransactionId(), true), 16843266);
		assertEquals(Utils.decodeTransactionId(msg.getMessage().getDestinationTransactionId(), true), 50529284);
		assertNull(msg.getParsingErrorReason());
	...
	public void testTCResponse() throws IOException, ParseException {
		...
		assertEquals(Utils.decodeTransactionId(msg.getMessage().getDestinationTransactionId(), true), 335544320);
		assertNull(msg.getParsingErrorReason());
